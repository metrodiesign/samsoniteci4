...
<?php if ($BranchID !== null && $BranchID !== 0): ?>
<script src="<?= base_url('assets/js/addOrder.js') ?>" type="text/javascript"></script>
<?php else: ?>
<script src="<?= base_url('assets/js/admin_addOrder.js') ?>" type="text/javascript"></script>
<?php endif ?>
