               ...
               <div class="col-md-12">
                 <!-- general form elements -->
                  ...
                  <div class="box box-primary">
                       ...
                       <form role="form" id="addEstimateprice" action="<?php echo base_url() ?>addNewEstimateprice" method="post" role="form">
                           <div class="box-body">
                               <div class="row">
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           ...
                                           <input type="text" class="form-control required" value="<?php echo set_value('estimateprice_details'); ?>" id="estimateprice_details" name="estimateprice_details" >
                                       </div>
