              ...
              <div class="col-md-12">
                <!-- general form elements -->
                  ...
                  <div class="box box-primary">
                      ...
                      <form role="form" id="addFixed" action="<?php echo base_url() ?>addNewFixed" method="post" role="form">
                          <div class="box-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control required" value="<?php echo set_value('fixed_details'); ?>" id="fixed_details" name="fixed_details" >
                                      </div>
