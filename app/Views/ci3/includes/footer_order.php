...
<footer class="main-footer">
    ...
    <script src="<?php echo base_url(); ?>assets/js/browse/jquery.knob.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/browse/jquery.ui.widget.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/browse/jquery.iframe-transport.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/browse/jquery.fileupload.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/browse/script.js"></script>
