<div class="content-wrapper">
    ...
    <div class="content-form">
      <section class="content-header">
        <h1>
          <i class="fa fa-users"></i> Upload Management
               ...
               <div class="col-md-12">
                 <!-- general form elements -->
                  ...
                  <div class="box box-primary">
                       ...
                       <form role="form" id="addUser" action="<?php echo base_url() ?>ExcelDataAdd" method="post" role="form" enctype="multipart/form-data">
                           <div class="box-body">
