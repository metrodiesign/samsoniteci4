<div class="content-wrapper">
  ...
  <div class="content-table-form">
    <section class="content-header">
      <h1>
        <i class="fa fa-link"></i> DELIVER TO CUSTOMER
      </h1>
    </section>
          ...
          <div class="box box-scroll">
            <div class="box-header">
              <div class="col-sm-12 col-lg-6">
                <h3 class="box-title">DELIVER TO CUSTOMER List</h3>
              </div>
              <div class="col-sm-12 col-lg-6">
                <div class="box-tools">
                  <form action="<?php echo base_url() ?>TrackingreturnListing" method="POST" id="searchList">
            ...
            <form action="<?php echo base_url() ?>sendorder_deliver" method="POST" id="sendorderUpdateStatus">
                ...
                <select id="status_id" name="status_id" style="width: 200px;">
                  ...
                  if (!empty($Status)) {
                    foreach ($Status as $rl) {
                      if ($rl->status_id == 5) {
                  ?>
                        <option value="<?php echo $rl->status_id ?>" <?php if ($rl->status_id == set_value('status_id')) {
                                                                        echo "selected=selected";
                                                                      } ?>><?php echo $rl->status_name ?></option>
                  <?php
                      }
                    }
                  }
...
<script type="text/javascript">
  ...
  jQuery(document).ready(function() {
    jQuery('ul.pagination li a').click(function(e) {
      ...
      jQuery("#searchList").attr("action", baseURL + "TrackingreturnListing/" + value);
