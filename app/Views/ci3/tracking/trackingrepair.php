<div class="content-wrapper">
    ...
    <div class="content-table-form">
      <section class="content-header">
        <h1>
          <i class="fa fa-cart-arrow-down"></i> STATUS REPAIR
        </h1>
      </section>
                 ...
                 <div class="box box-scroll">
                  <div class="box-header">
                    <div class="col-sm-12 col-lg-6">
                        <h3 class="box-title">STATUS REPAIR List</h3>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                      <div class="box-tools">
                          <form action="<?php echo base_url() ?>TrackingcloseListing" method="POST" id="searchList">
                  ...
                  <select id="status_id" name="status_id" style="width: 200px;" >
                       ...
                       if(!empty($Status))
                       {
                         //var_dum($Providers);
                           ...
                           {
                             if($rl->status_id>3 and $rl->status_id<5){
                               ?>
...
jQuery(document).ready(function(){
    jQuery('ul.pagination li a').click(function (e) {
        ...
        jQuery("#searchList").attr("action", baseURL + "TrackingcloseListing/" + value);
