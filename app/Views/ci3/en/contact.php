      ...
      <div class="row">
        <div class="col-lg-8 con-box-wrapper">
           <div class="col-sm-12 col-xs-12 col-lg-6 contact-wrapper" style="border-right: 1px solid #CCCCCC;">
             ...
             <div class="ico-txt-detail">
               ...
               <div class="">BANGKOK 10110</div>
               <div class="">TEL. 02-229-7190-95</div>
             </div>
             <div class="" style="text-align: right">
                 <input type="submit"  class="main-btn-sm"value="Google Map" onclick="window.location.href='https://goo.gl/maps/uH7TMBuW1w22'"/>
             </div>
           </div>
        ...
        <div class="col-lg-5 con-box-info">
          ...
          <form role="form" id="addContact" action="<?php echo base_url() ?>contact/addContact" method="post" role="form">
            ...
            <div class="control-input">
              <input type="text" name="email" class="main-input form-control required email" id="email" value="<?php echo set_value('email'); ?>"  placeholder="E-mail *">
            </div>
            <!-- <div class="control-input">
