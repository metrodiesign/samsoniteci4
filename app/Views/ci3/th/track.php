...
<form role="form" id="addtrack" action="<?php echo base_url() ?>track_th/trackstatus" method="post" role="form">
<section id="track"> 
  ...
  <div class="container">
    <div class="row">
      <div class="con-center-track">
        ...
        <input type="text" name="searchText" id="searchText" class="search-txt form-control required" value="<?php echo set_value('searchText'); ?>"  placeholder="ระบุรหัสติดตามของคุณ" style="height: 70px; text-transform: uppercase;" >

        <div class="">
          <!-- <a href="" style="text-decoration: none;"> -->
            <button type="button" id="btnModal" class="main-btn-sm" data-toggle="modal" data-target="#exampleModal">วิธีตรวจสอบสถานะ</button>
          <!-- </a> -->
            <input type="submit"  class="main-btn-sm"value="ติดตาม" />
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="" style="text-align: left; line-height: 1; font-size: 1.2em; color: #7b7b7b;">
                  <img class="rs-bg-size" src="<?php echo base_url(); ?>assets/images/popup_th.png">
               </div>
            </div>
