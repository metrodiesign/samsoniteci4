...
<?php $exportQuery = http_build_query(array_filter(['start_date' => $startDate, 'end_date' => $endDate, 'status_id' => $kind === 'in-progress' ? $statusId : ''], static fn (string $value): bool => $value !== '')); ?>
