...
[""]).pop().replace(A,"");case "z":return(0<h?"-":"+")+Math.floor(Math.abs(h)/60);case "zz":return(0<h?"-":"+")+da(Math.floor(Math.abs(h)/60),2);case "zzz":return(0<h?"-":"+")+da(Math.floor(Math.abs(h)/60),2)+da(Math.abs(h)%60,2);default:return q.slice(1,q.length-1)}})}}(),ob=function(d){var m=0>d;if(1>Math.abs(d)){var n=parseInt(d.toString().split("e-")[1]);n&&(d=(m?-1*d:d)*Math.pow(10,n-1),d="0."+Array(n).join("0")+d.toString().substring(2),d=m?"-"+d:d)}else n=parseInt(d.toString().split("+")[1]),
...
[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var h,q,y;y=e-1;h=0===y?0:y-1;q=y===a.length-1?y:y+1;b=Math.abs((a[q].x-a[h].x)/(0===a[q].x-a[y].x?0.01:a[q].x-a[y].x))*(g-1)/2+1;var I=(a[q].x-a[h].x)/b;b=(a[q].y-a[h].y)/b;c[c.length]=a[y].x>a[h].x&&0<I||a[y].x<a[h].x&&0>I?{x:a[y].x+I/3,y:a[y].y+b/3}:{x:a[y].x,y:a[y].y+(1===c.length?0:b/9)};y=e;h=0===y?0:y-1;q=y===a.length-1?y:y+1;b=Math.abs((a[q].x-a[h].x)/(0===a[y].x-a[h].x?0.01:a[y].x-a[h].x))*(g-1)/2+1;I=(a[q].x-a[h].x)/b;b=(a[q].y-a[h].y)/b;
c[c.length]=a[y].x>a[h].x&&0<I||a[y].x<a[h].x&&0>I?{x:a[y].x-I/3,y:a[y].y-b/3}:{x:a[y].x,y:a[y].y-b/9};c[c.length]=a[e]}return c}function B(a,g,c,b,e,h,q,y,I,k){var l=0;k?(q.color=h,y.color=h):k=1;l=I?Math.abs(e-c):Math.abs(b-g);l=0<q.trimLength?Math.abs(l*q.trimLength/100):Math.abs(l-q.length);I?(c+=l/2,e-=l/2):(g+=l/2,b-=l/2);var l=1===Math.round(q.thickness)%2?0.5:0,p=1===Math.round(y.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=y.color||h;a.lineWidth=y.thickness||2;a.setLineDash&&
a.setLineDash(G(y.dashType,y.thickness));a.beginPath();I&&0<y.thickness?(a.moveTo(b-q.thickness/2,Math.round((c+e)/2)-p),a.lineTo(g+q.thickness/2,Math.round((c+e)/2)-p)):0<y.thickness&&(a.moveTo(Math.round((g+b)/2)-p,c+q.thickness/2),a.lineTo(Math.round((g+b)/2)-p,e-q.thickness/2));a.stroke();a.strokeStyle=q.color||h;a.lineWidth=q.thickness||2;a.setLineDash&&a.setLineDash(G(q.dashType,q.thickness));a.beginPath();I&&0<q.thickness?(a.moveTo(b-l,c),a.lineTo(b-l,e),a.moveTo(g+l,c),a.lineTo(g+l,e)):0<
q.thickness&&(a.moveTo(g,c+l),a.lineTo(b,c+l),a.moveTo(g,e-l),a.lineTo(b,e-l));a.stroke();a.restore()}function P(a,g){P.base.constructor.call(this,"Legend","legend",g,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));
...
a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,a.stockChart));a.render();a.syncCharts&&(a.stockChart.rangeUpdatedBy=!a.stockChart.navigator.slider||n(a.stockChart.navigator.slider.options.minimum)&&n(a.stockChart.navigator.slider.options.maximum)?n(a.stockChart.rangeSelector.inputFields.options.startValue)&&n(a.stockChart.rangeSelector.inputFields.options.endValue)?n(a.stockChart.rangeSelector.options.selectedRangeButtonIndex)?null:"rangeButton":"inputFields":"navigator",
a.syncCharts(null,null),"rangeButton"===a.stockChart.rangeUpdatedBy&&a.stockChart.rangeSelector.selectedRangeButtonIndex<a.stockChart.rangeSelector.buttons.length&&(b=a.stockChart.rangeSelector.buttons[a.stockChart.rangeSelector.selectedRangeButtonIndex],b.state="on",b.textBlock.fontWeight="bold",b.textBlock.fontColor=a.stockChart.rangeSelector.buttonStyle.labelFontColorOnHover,b.textBlock.backgroundColor=a.stockChart.rangeSelector.buttonStyle.backgroundColorOnSelect,b.render()));a._dispatchRangeEvent("rangeChanged",
"reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),H(this._resetButton,"mousemove",function(){g||(O(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&O(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},
this.allDOMEventHandlers),H(this._resetButton,"mouseout",function(){g||(O(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&O(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?
(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),La(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;ib(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?sa(a,a._zoomButton,"zoom"):sa(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&sa(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=
this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};m.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];var g=0,c=0;this.options.width?g=this.width:this.width=g=0<this.container.clientWidth?this.container.clientWidth:this.width;n(this.stockChart)||n(this.index)?this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height:
c=this.height=this.stockChart._chartsHeight[this.index];if(this.canvas.width!==g*la||this.canvas.height!==c*la){for(var b=0;b<a.length;b++)Ma(a[b],g,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=n(this.parent)||n(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this._animator?this._animator.cancelAllAnimations():this._animator=new $(this);this.removeAllEventListeners();
this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=w&&this.animationEnabled&&0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ea(0,0,this.width,
this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,g=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new V(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);if(!n(b)&&b.dataPoints)for(var e=0;e<b.dataPoints.length;e++)if(b.dataPoints[e].x&&b.dataPoints[e].x.getTime){b.xValueType=
"dateTime";break}"error"===b.type&&(b.linkedDataSeriesIndex=n(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&(b.linkedDataSeriesIndex=null);null===b.name&&(b.name="DataSeries "+a);null===b.color?1<this.options.data.length?(b._colorSet=[this.selectedColorSet[b.index%this.selectedColorSet.length]],
...
3;w&&this._breaksCanvas&&(this._preRenderCtx.drawImage(this.canvas,0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(g=0;g<this.plotInfo.plotTypes.length;g++)for(var h=this.plotInfo.plotTypes[g],q=0;q<h.plotUnits.length;q++){var y=h.plotUnits[q],
...
b=!1,e=null,h=!1,q=0;q<this.plotInfo.plotTypes.length;q++)if(this.plotInfo.plotTypes[q].type===a.type){b=!0;c=this.plotInfo.plotTypes[q];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(q=0;q<c.plotUnits.length;q++)if(c.plotUnits[q].axisYType===a.axisYType&&c.plotUnits[q].axisXType===a.axisXType&&c.plotUnits[q].axisYIndex===a.axisYIndex&&c.plotUnits[q].axisXIndex===a.axisXIndex){h=!0;e=c.plotUnits[q];break}h||(e={type:a.type,previousDataSeriesCount:0,index:c.plotUnits.length,
...
c.plotUnits.push(e));c.totalDataSeries++;e.dataSeriesIndexes.push(g);a.plotUnit=e}for(g=0;g<this.plotInfo.plotTypes.length;g++)for(c=this.plotInfo.plotTypes[g],q=a=0;q<c.plotUnits.length;q++)c.plotUnits[q].previousDataSeriesCount=a,a+=c.plotUnits[q].dataSeriesIndexes.length};m.prototype.assignIdToDataPoints=function(){for(var a=0;a<this.data.length;a++){var g=this.data[a];if(g.dataPoints)for(var c=g.dataPoints.length,b=0;b<c;b++)g.dataPointIds[b]=++this._eventManager.lastObjectId}};m.prototype._processData=
...
!(1>a.dataSeriesIndexes.length))for(var g=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,h=!1,q=0;q<a.dataSeriesIndexes.length;q++){var y=this.data[a.dataSeriesIndexes[q]],I=0,k=!1,l=!1,p;if("normal"===y.axisPlacement||"xySwapped"===y.axisPlacement)var r=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?
...
(d*=-1),g.minDiff>d&&0!==d&&(g.minDiff=d)))}if(b<r&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<I)){I-=2;continue}if(b>f&&!l)l=!0;else if(b>f&&l)continue;y.dataPoints[I].label&&(a.axisX.labels[b]=y.dataPoints[I].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<g.viewPortMin&&"number"===typeof e&&(g.viewPortMin=e),e>g.viewPortMax&&"number"===typeof e&&(g.viewPortMax=e))}}y.axisX.valueType=y.xValueType=h?"dateTime":"number"}};
m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var g=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,h=!1,q=[],y=[],I=Infinity,k=-Infinity,l={},p=0;p<a.dataSeriesIndexes.length;p++){var r=this.data[a.dataSeriesIndexes[p]],f=0,d=!1,v=!1,x;if("normal"===r.axisPlacement||"xySwapped"===r.axisPlacement)var s=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:
a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:-Infinity,z=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:a.axisX.options&&a.axisX.options.viewportMaximum?a.axisX.options.viewportMaximum:a.axisX.options&&a.axisX.options.maximum?a.axisX.options.maximum:Infinity;if(r.dataPoints[f].x&&r.dataPoints[f].x.getTime||"dateTime"===r.xValueType)h=!0;for(f=0;f<r.dataPoints.length;f++){"undefined"===typeof r.dataPoints[f].x&&(r.dataPoints[f].x=f+(a.axisX.logarithmic?
1:0));r.dataPoints[f].x.getTime?(h=!0,b=r.dataPoints[f].x.getTime()):b=r.dataPoints[f].x;e=n(r.dataPoints[f].y)?0:r.dataPoints[f].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<f){if(a.axisX.logarithmic){var u=b/r.dataPoints[f-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-r.dataPoints[f-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);null!==e&&null!==r.dataPoints[f-1].y&&(a.axisY.logarithmic?0<e&&(u=e/r.dataPoints[f-1].y,1>u&&(u=1/u),g.minDiff>u&&1!==u&&(g.minDiff=u)):(u=e-r.dataPoints[f-
1].y,0>u&&(u*=-1),g.minDiff>u&&0!==u&&(g.minDiff=u)))}if(b<s&&!d)null!==r.dataPoints[f].y&&(x=b);else{if(!d&&(d=!0,0<f)){f-=2;continue}if(b>z&&!v)v=!0;else if(b>z&&v)continue;r.dataPoints[f].label&&(a.axisX.labels[b]=r.dataPoints[f].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===r.dataPoints[f].y?c.viewPortMin===b&&x<b&&(c.viewPortMin=x):(l[b]=(l[b]||0)+r.dataPoints[f].y,r.dataPointEOs[f].cumulativeY=l[b],a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=
(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?q[b]?q[b]+=e:(q[b]=e,I=Math.min(e,I)):y[b]?y[b]+=e:(y[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(g.dataPointYPositiveSums?(g.dataPointYPositiveSums.push.apply(g.dataPointYPositiveSums,q),g.dataPointYNegativeSums.push.apply(g.dataPointYPositiveSums,y)):(g.dataPointYPositiveSums=q,g.dataPointYNegativeSums=y));r.axisX.valueType=r.xValueType=h?"dateTime":"number"}for(f in q)q.hasOwnProperty(f)&&
!isNaN(f)&&(a=q[f],a<g.min&&(g.min=Math.min(a,I)),a>g.max&&(g.max=a),f<c.viewPortMin||f>c.viewPortMax||(a<g.viewPortMin&&(g.viewPortMin=Math.min(a,I)),a>g.viewPortMax&&(g.viewPortMax=a)));for(f in y)y.hasOwnProperty(f)&&!isNaN(f)&&(a=y[f],a<g.min&&(g.min=a),a>g.max&&(g.max=Math.max(a,k)),f<c.viewPortMin||f>c.viewPortMax||(a<g.viewPortMin&&(g.viewPortMin=a),a>g.viewPortMax&&(g.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var g=
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,h=!1,q=!1,y=!1,I={},k=[],l=0;l<a.dataSeriesIndexes.length;l++){var p=this.data[a.dataSeriesIndexes[l]],r=0,f=!1,d=!1,v;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var x=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:-Infinity,s=a.axisX.sessionVariables.newViewportMaximum?
a.axisX.sessionVariables.newViewportMaximum:a.axisX.options&&a.axisX.options.viewportMaximum?a.axisX.options.viewportMaximum:a.axisX.options&&a.axisX.options.maximum?a.axisX.options.maximum:Infinity;if(p.dataPoints[r].x&&p.dataPoints[r].x.getTime||"dateTime"===p.xValueType)h=!0;for(r=0;r<p.dataPoints.length;r++){"undefined"===typeof p.dataPoints[r].x&&(p.dataPoints[r].x=r+(a.axisX.logarithmic?1:0));p.dataPoints[r].x.getTime?(h=!0,b=p.dataPoints[r].x.getTime()):b=p.dataPoints[r].x;e=n(p.dataPoints[r].y)?
null:p.dataPoints[r].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<r){if(a.axisX.logarithmic){var z=b/p.dataPoints[r-1].x;1>z&&(z=1/z);c.minDiff>z&&1!==z&&(c.minDiff=z)}else z=b-p.dataPoints[r-1].x,0>z&&(z*=-1),c.minDiff>z&&0!==z&&(c.minDiff=z);n(e)||null===p.dataPoints[r-1].y||(a.axisY.logarithmic?0<e&&(z=e/p.dataPoints[r-1].y,1>z&&(z=1/z),g.minDiff>z&&1!==z&&(g.minDiff=z)):(z=e-p.dataPoints[r-1].y,0>z&&(z*=-1),g.minDiff>z&&0!==z&&(g.minDiff=z)))}if(b<x&&!f)null!==e&&(v=b);else{if(!f&&(f=!0,0<r)){r-=
2;continue}if(b>s&&!d)d=!0;else if(b>s&&d)continue;p.dataPoints[r].label&&(a.axisX.labels[b]=p.dataPoints[r].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&v<b&&(c.viewPortMin=v):(I[b]=(I[b]||0)+p.dataPoints[r].y,p.dataPointEOs[r].cumulativeY=I[b],a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?q=!0:0>e&&(y=!0),k[b]=k[b]?k[b]+Math.abs(e):Math.abs(e))}}p.axisX.valueType=p.xValueType=
h?"dateTime":"number"}a.axisY.logarithmic?(g.max=n(g.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(g.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),g.min=n(g.viewPortMin)?1:Math.min(g.viewPortMin,1)):q&&!y?(g.max=n(g.viewPortMax)?99:Math.max(g.viewPortMax,99),g.min=n(g.viewPortMin)?1:Math.min(g.viewPortMin,1)):q&&y?(g.max=n(g.viewPortMax)?99:Math.max(g.viewPortMax,99),g.min=n(g.viewPortMin)?-99:Math.min(g.viewPortMin,-99)):!q&&y&&(g.max=n(g.viewPortMax)?-1:Math.max(g.viewPortMax,
-1),g.min=n(g.viewPortMin)?-99:Math.min(g.viewPortMin,-99));g.viewPortMin=g.min;g.viewPortMax=g.max;a.dataPointYSums=k}};m.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var g=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,h,q,y=!1,I=0;I<a.dataSeriesIndexes.length;I++){var k=this.data[a.dataSeriesIndexes[I]],l=0,p=!1,r=!1,f,d,n;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var x=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:
...
for(l=0;l<k.dataPoints.length;l++){"undefined"===typeof k.dataPoints[l].x&&(k.dataPoints[l].x=l+(a.axisX.logarithmic?1:0));k.dataPoints[l].x.getTime?(y=!0,b=k.dataPoints[l].x.getTime()):b=k.dataPoints[l].x;if((e=k.dataPoints[l].y)&&e.length){h=Math.min.apply(null,e);q=Math.max.apply(null,e);d=!0;for(var z=0;z<e.length;z++)null===e.k&&(d=!1);d&&(p||(n=f),f=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);h<g.min&&(g.min=h);q>g.max&&(g.max=q);0<l&&(a.axisX.logarithmic?(d=b/k.dataPoints[l-1].x,1>d&&(d=1/d),
c.minDiff>d&&1!==d&&(c.minDiff=d)):(d=b-k.dataPoints[l-1].x,0>d&&(d*=-1),c.minDiff>d&&0!==d&&(c.minDiff=d)),e&&(null!==e[0]&&k.dataPoints[l-1].y&&null!==k.dataPoints[l-1].y[0])&&(a.axisY.logarithmic?(d=e[0]/k.dataPoints[l-1].y[0],1>d&&(d=1/d),g.minDiff>d&&1!==d&&(g.minDiff=d)):(d=e[0]-k.dataPoints[l-1].y[0],0>d&&(d*=-1),g.minDiff>d&&0!==d&&(g.minDiff=d))));if(!(b<x)||p){if(!p&&(p=!0,0<l)){l-=2;f=n;continue}if(b>s&&!r)r=!0;else if(b>s&&r)continue;k.dataPoints[l].label&&(a.axisX.labels[b]=k.dataPoints[l].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(z=0;z<e.length;z++)if(null===e[z]&&f<b){c.viewPortMin=f;break}null===e?c.viewPortMin===b&&f<b&&(c.viewPortMin=f):(h<g.viewPortMin&&(g.viewPortMin=h),q>g.viewPortMax&&(g.viewPortMax=q))}}k.axisX.valueType=k.xValueType=y?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var g=a.axisY.dataInfo,c=a.axisX.dataInfo,
b,e,h=!1,q=0;q<a.dataSeriesIndexes.length;q++){var y=this.data[a.dataSeriesIndexes[q]],d=0,k=!1,l=!1,p=b=0;if("normal"===y.axisPlacement||"xySwapped"===y.axisPlacement)var r=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?0:-Infinity,f=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:
...
b/y.dataPoints[d-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-y.dataPoints[d-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==y.dataPoints[d-1].y&&(a.axisY.logarithmic?(e=y.dataPointEOs[d].cumulativeSum/y.dataPointEOs[d-1].cumulativeSum,1>e&&(e=1/e),g.minDiff>e&&1!==e&&(g.minDiff=e)):(e=y.dataPointEOs[d].cumulativeSum-y.dataPointEOs[d-1].cumulativeSum,0>e&&(e*=-1),g.minDiff>e&&0!==e&&(g.minDiff=e)))),!(b<r)||k){if(!k&&(k=!0,0<d)){d-=2;continue}if(b>f&&!l)l=!0;else if(b>
...
1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks,c=a.axisY.scaleBreaks&&a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var f=a.axisY.dataInfo,g=a.axisX.dataInfo,h,q=g.min,k=g.max,l=f.min,p=f.max,g=g._dataRanges,f=f._dataRanges,r,y=0,d=0;d<a.dataSeriesIndexes.length;d++){var I=e.data[a.dataSeriesIndexes[d]];if(!(4>I.dataPoints.length))for(y=0;y<I.dataPoints.length;y++)if(b&&(r=(k+1-q)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,
h=I.dataPoints[y].x.getTime?I.dataPoints[y].x.getTime():I.dataPoints[y].x,r=Math.floor((h-q)/r),h<g[r].min&&(g[r].min=h),h>g[r].max&&(g[r].max=h)),c){var w=(p+1-l)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((h="waterfall"===a.type?I.dataPointEOs[y].cumulativeSum:I.dataPoints[y].y)&&h.length)for(var m=0;m<h.length;m++)r=Math.floor((h[m]-l)/w),h[m]<f[r].min&&(f[r].min=h[m]),h[m]>f[r].max&&(f[r].max=h[m]);else n(h)||(r=Math.floor((h-l)/w),h<f[r].min&&(f[r].min=h),h>
f[r].max&&(f[r].max=h))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,f=b.max,g=b._dataRanges,h,q=0,k=0;k<a.dataSeriesIndexes.length;k++){var l=e.data[a.dataSeriesIndexes[k]];if(!(4>l.dataPoints.length))for(q=0;q<l.dataPoints.length;q++)h=(f+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=l.dataPoints[q].x.getTime?
l.dataPoints[q].x.getTime():l.dataPoints[q].x,h=Math.floor((b-c)/h),b<g[h].min&&(g[h].min=b),b>g[h].max&&(g[h].max=b)}}for(var b,e=this,h=!1,q=0;q<this._axes.length;q++)if(this._axes[q].scaleBreaks&&this._axes[q].scaleBreaks.autoCalculate&&1<=this._axes[q].scaleBreaks.maxNumberOfAutoBreaks){h=!0;this._axes[q].dataInfo._dataRanges=[];for(var y=0;y<100/Math.max(parseFloat(this._axes[q].scaleBreaks.collapsibleThreshold)||10,10);y++)this._axes[q].dataInfo._dataRanges.push({min:Infinity,max:-Infinity})}if(h){for(q=
0;q<this.plotInfo.plotTypes.length;q++)for(h=this.plotInfo.plotTypes[q],y=0;y<h.plotUnits.length;y++)b=h.plotUnits[y],"line"===b.type||"stepLine"===b.type||"spline"===b.type||"column"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"bar"===b.type||"bubble"===b.type||"scatter"===b.type||"candlestick"===b.type||"ohlc"===b.type||"rangeColumn"===b.type||"rangeBar"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type||"waterfall"===b.type||"error"===b.type||"boxAndWhisker"===
b.type?g(b):0<=b.type.indexOf("stacked")&&c(b);for(q=0;q<this._axes.length;q++)if(this._axes[q].dataInfo._dataRanges){var d=this._axes[q].dataInfo.min;b=(this._axes[q].dataInfo.max+1-d)*Math.max(parseFloat(this._axes[q].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[q].dataInfo._dataRanges,l,p,h=[];if(this._axes[q].dataInfo.dataPointYPositiveSums){var r=this._axes[q].dataInfo.dataPointYPositiveSums;l=k;for(y in r)if(r.hasOwnProperty(y)&&!isNaN(y)&&(p=r[y],!n(p))){var f=Math.floor((p-
d)/b);p<l[f].min&&(l[f].min=p);p>l[f].max&&(l[f].max=p)}delete this._axes[q].dataInfo.dataPointYPositiveSums}if(this._axes[q].dataInfo.dataPointYNegativeSums){r=this._axes[q].dataInfo.dataPointYNegativeSums;l=k;for(y in r)r.hasOwnProperty(y)&&!isNaN(y)&&(p=-1*r[y],n(p)||(f=Math.floor((p-d)/b),p<l[f].min&&(l[f].min=p),p>l[f].max&&(l[f].max=p)));delete this._axes[q].dataInfo.dataPointYNegativeSums}for(y=0;y<k.length-1;y++)if(l=k[y].max,isFinite(l))for(;y<k.length-1;)if(d=k[y+1].min,isFinite(d)){p=d-
l;p>b&&h.push({diff:p,start:l,end:d});break}else y++;if(this._axes[q].scaleBreaks.customBreaks)for(y=0;y<this._axes[q].scaleBreaks.customBreaks.length;y++)for(b=0;b<h.length;b++)if(this._axes[q].scaleBreaks.customBreaks[y].startValue<=h[b].start&&h[b].start<=this._axes[q].scaleBreaks.customBreaks[y].endValue||this._axes[q].scaleBreaks.customBreaks[y].startValue<=h[b].start&&h[b].start<=this._axes[q].scaleBreaks.customBreaks[y].endValue||h[b].start<=this._axes[q].scaleBreaks.customBreaks[y].startValue&&
this._axes[q].scaleBreaks.customBreaks[y].startValue<=h[b].end||h[b].start<=this._axes[q].scaleBreaks.customBreaks[y].endValue&&this._axes[q].scaleBreaks.customBreaks[y].endValue<=h[b].end)h.splice(b,1),b--;h.sort(function(a,b){return b.diff-a.diff});for(y=0;y<Math.min(h.length,this._axes[q].scaleBreaks.maxNumberOfAutoBreaks);y++)b=a(h[y].start,h[y].end,this._axes[q].logarithmic?this._axes[q].dataInfo.max/this._axes[q].dataInfo.min:this._axes[q].dataInfo.max-this._axes[q].dataInfo.min,this._axes[q].logarithmic),
this._axes[q].scaleBreaks.autoBreaks.push(new ca(this,"autoBreaks",b,y,++this._eventManager.lastObjectId,this._axes[q].scaleBreaks)),this._axes[q].scaleBreaks._appliedBreaks.push(this._axes[q].scaleBreaks.autoBreaks[this._axes[q].scaleBreaks.autoBreaks.length-1]);this._axes[q].scaleBreaks._appliedBreaks.sort(function(a,b){return a.startValue-b.startValue})}}};m.prototype.renderCrosshairs=function(a){for(var g=0;g<this.axisX.length;g++)this.axisX[g]!=a&&(this.axisX[g].crosshair&&this.axisX[g].crosshair.enabled&&
...
1<c.length)){e=Pa(b);e.time=new Date;try{var q=e.y-this._lastTouchData.y,h=e.time-this._lastTouchData.time;if(1<Math.abs(q)&&this._lastTouchData.scroll||5<Math.abs(q)&&250>h)this._lastTouchData.scroll=!0}catch(y){}this._lastTouchEventType=a.type;if(this._lastTouchData.scroll&&this.zoomEnabled)this.isDrag&&this.resetOverlayedCanvas(),this.isDrag=!1;else for(c=0;c<g.length;c++)if(e=g[c],q=document.createEvent("MouseEvent"),q.initMouseEvent(e,!0,!0,window,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,
!1,!1,!1,0,null),b.target.dispatchEvent(q),!n(this._lastTouchData.scroll)&&!this._lastTouchData.scroll||!this._lastTouchData.scroll&&250<h||"click"===e)a.preventManipulation&&a.preventManipulation(),a.preventDefault&&a.cancelable&&a.preventDefault()}}};m.prototype._dispatchRangeEvent=function(a,g){var c={chart:this};c.type=a;c.trigger=g;var b=[];this.axisX&&0<this.axisX.length&&b.push("axisX");this.axisX2&&0<this.axisX2.length&&b.push("axisX2");this.axisY&&0<this.axisY.length&&b.push("axisY");this.axisY2&&
...
this._events[h],q=e.bounds,c.x>=q.x1&&c.x<=q.x2&&c.y>=q.y1&&c.y<=q.y2){e[b].call(e.context,c.x,c.y);"mousedown"===b&&!0===e.capture?(m.capturedEventParam=e,this.overlaidCanvas.setCapture?this.overlaidCanvas.setCapture():document.documentElement.addEventListener("mouseup",this._mouseEventHandler,!1)):"mouseup"===b&&(e.chart.overlaidCanvas.releaseCapture?e.chart.overlaidCanvas.releaseCapture():document.documentElement.removeEventListener("mouseup",this._mouseEventHandler,!1));break}else e=null;a.target.style.cursor=
...
g-this.dragStartPoint.y,b=a-this.dragStartPoint.x,e=0<=this.zoomType.indexOf("x"),h=0<=this.zoomType.indexOf("y"),q=!1;this.resetOverlayedCanvas();if("xySwapped"===this.plotInfo.axisPlacement)var y=h,h=e,e=y;if(this.panEnabled||this.zoomEnabled){if(this.panEnabled)for(e=h=0;e<this._axes.length;e++)c=this._axes[e],c.logarithmic?c.viewportMinimum<c.minimum?(h=c.minimum/c.viewportMinimum,c.sessionVariables.newViewportMinimum=c.viewportMinimum*h,c.sessionVariables.newViewportMaximum=c.viewportMaximum*
...
"rangeChanged",q.stockChart.dispatchEvent("rangeChanged",q.stockChart._rangeEventParameter,q.stockChart)),q.dragStartPoint.x=a,q.dragStartPoint.y=g)}}(e.x1,e.y1,e.x2,e.y2),0);else if(this.zoomEnabled){this.resetOverlayedCanvas();c=this.overlaidCanvasCtx.globalAlpha;this.overlaidCanvasCtx.fillStyle="#A89896";var b=e?this.dragStartPoint.x:this.plotArea.x1,y=h?this.dragStartPoint.y:this.plotArea.y1,d=e?a-this.dragStartPoint.x:this.plotArea.x2-this.plotArea.x1,k=h?g-this.dragStartPoint.y:this.plotArea.y2-
...
{stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};m.prototype.validateRegion=function(a,g,c,b,e){e=e||!1;for(var h=0<=this.zoomType.indexOf("x"),q=0<=this.zoomType.indexOf("y"),y=!1,d=[],k=[],l=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&h||"axisY"===this._axes[p].type&&q)&&k.push(this._axes[p]);for(q=0;q<k.length;q++){var p=k[q],h=!1,r=p.convertPixelToValue({x:a,y:g}),f=p.convertPixelToValue({x:c,
y:b});if(r>f)var n=f,f=r,r=n;if(p.scaleBreaks)for(n=0;!h&&n<p.scaleBreaks._appliedBreaks.length;n++)h=p.scaleBreaks._appliedBreaks[n].startValue<=r&&p.scaleBreaks._appliedBreaks[n].endValue>=f;if(isFinite(p.dataInfo.minDiff))if(n=p.getApparentDifference(r,f,null,!0),!(h||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&n<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&n<3*Math.abs(p.dataInfo.minDiff))||r<p.minimum||f>p.maximum))d.push(p),l.push({val1:r,val2:f}),
...
a.x1=g.x1,a.x2=g.x2,a.y1=g.y1,a.y2=g.y2,a.width=g.width,a.height=g.height;w||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ea(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var g=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,h=0,q=e=h=0,y=0,d=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var l=this._indexLabels[a],p=l.chartType.toLowerCase(),r,f,y=ma("indexLabelFontColor",
l.dataPoint,l.dataSeries),Ra=ma("indexLabelFontSize",l.dataPoint,l.dataSeries),d=ma("indexLabelFontFamily",l.dataPoint,l.dataSeries),k=ma("indexLabelFontStyle",l.dataPoint,l.dataSeries);r=ma("indexLabelFontWeight",l.dataPoint,l.dataSeries);var v=ma("indexLabelBackgroundColor",l.dataPoint,l.dataSeries);f=ma("indexLabelMaxWidth",l.dataPoint,l.dataSeries);var h=ma("indexLabelWrap",l.dataPoint,l.dataSeries),x=ma("indexLabelLineDashType",l.dataPoint,l.dataSeries),s=ma("indexLabelLineColor",l.dataPoint,
...
2&&(f+=Math.abs(f-v._lineHeight/2)<=(l.bounds.y2-l.bounds.y1)/2+y?Math.abs(f-v._lineHeight/2):(l.bounds.y2-l.bounds.y1)/2+y)}else f=Math.min(l.point.y,b),f>h-k-y&&("bubble"===p||"scatter"===p)&&(f=Math.min(l.point.y+y,c.y2-k-y));f=Math.min(f,h)}}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(u="auto",q=4):0<=p.indexOf("stacked")?"auto"===u&&(u="inside"):"bubble"===p&&(u="inside"),f=l.point.y+v._lineHeight/2-k/2,"inside"!==u?(h=c.x1,e=c.x2,0>t?(r=l.point.x-d+("horizontal"===
m?0:v._lineHeight/2)-q-b,("horizontal"===m?r:r-v._lineHeight/2)<h&&(r="auto"===u?Math.max(l.point.x,h)+("horizontal"===m?0:v._lineHeight/2)+y+b:h+("horizontal"===m?0:v._lineHeight/2)+q,(B=r+d-("horizontal"===m?0:v._lineHeight/2)>l.point.x)&&(r-=b))):(r=l.point.x+("horizontal"===m?0:v._lineHeight/2)+q+b,("horizontal"===m?r:r-v._lineHeight/2)>e-d-q-b&&(r="auto"===u?Math.min(l.point.x,e)-("horizontal"===m?d:d-v._lineHeight/2)-q-b:e-d-q+("horizontal"===m?0:v._lineHeight/2),(B=r-("horizontal"===m?0:v._lineHeight/
2)<l.point.x)&&(r+=b)))):(h=Math.max(l.bounds.x1,c.x1),Math.min(l.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>t?Math.max(l.bounds.x1,c.x1):Math.min(l.bounds.x2,c.x2)-d-q+("horizontal"===m?0:v._lineHeight/2):(Math.max(l.bounds.x1,c.x1)+Math.min(l.bounds.x2,c.x2))/2-d/2+("horizontal"===m?0:v._lineHeight/2),r=0>t?b:Math.min(l.point.x,b),r=Math.max(r,h+("horizontal"===m?0:v._lineHeight/2+y)));"vertical"===m&&(f+=k-v._lineHeight/2,0<="ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(p)&&
(B=0<t?f+("horizontal"===m?k-v._lineHeight/2:0)>l.point.y:f-("horizontal"===m?v._lineHeight/2:k)<l.point.y),"bubble"===p||"scatter"===p)&&(r+=v._lineHeight/2-Ra/2);v.x=r;v.y=f;v.render(!0);z&&("inside"!==u&&(0>p.indexOf("bar")&&("error"!==p||!l.axisSwapped)&&l.point.x>c.x1&&l.point.x<c.x2||!B)&&(-1==="ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(p)&&("error"!==p||l.axisSwapped)&&l.point.y>c.y1&&l.point.y<c.y2||!B))&&(g.lineWidth=z,g.strokeStyle=
s?s:"gray",g.setLineDash&&g.setLineDash(G(x,z)),g.beginPath(),g.moveTo(l.point.x,l.point.y),0<=p.indexOf("bar")||"error"===p&&l.axisSwapped?g.lineTo(r+(0<l.direction?0:d)+("vertical"===m?-v._lineHeight/2:0),f+("vertical"===m?-k/2:k/2-v._lineHeight/2)):0<=p.indexOf("column")||"error"===p&&!l.axisSwapped?g.lineTo(r+d/2-("horizontal"===m?0:v._lineHeight/2),f+("vertical"===m?f-k<l.point.y?0:-k:(f-v._lineHeight/2<l.point.y?k:0)-v._lineHeight/2)):0<=p.indexOf("waterfall")?g.lineTo(r+d/2-("horizontal"===
m?0:v._lineHeight/2),"vertical"===m?0<t&&f<l.point.y?f:0>t&&f-k>l.point.y?f-k:l.point.y:0<t&&f+k-v._lineHeight/2<l.point.y?f+k-v._lineHeight/2:0>t&&f-v._lineHeight/2>l.point.y?f-v._lineHeight/2:l.point.y):g.lineTo(r+d/2-("horizontal"===m?0:v._lineHeight/2),f+("vertical"===m?f-k<l.point.y?0:-k:(f+k-v._lineHeight/2<l.point.y?k:0)-v._lineHeight/2)),g.stroke())}}g={source:g,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0,startTimePercent:0.7};
...
(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(q.x,q.y),p=k.nullDataLineDashType,c.setLineDash(r)),c.lineTo(z,u),w&&b.lineTo(z,u)):(c.beginPath(),c.moveTo(z,u),w&&(b.beginPath(),b.moveTo(z,u))),m=x=!1):(c.lineTo(z,u),w&&b.lineTo(z,u),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(z,u),w&&(b.stroke(),b.beginPath(),b.moveTo(z,u))));q={x:z,y:u};s<l.length-1&&(v!==(l[s].lineColor||n)||p!==(l[s].lineDashType||
...
dataPointIndex:s,x1:z,y1:u};x||m?(!x&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(q.x,q.y),p=k.nullDataLineDashType,c.setLineDash(r)),c.lineTo(z,C),c.lineTo(z,u),w&&(b.lineTo(z,C),b.lineTo(z,u))):(c.beginPath(),c.moveTo(z,u),w&&(b.beginPath(),b.moveTo(z,u))),m=x=!1):(c.lineTo(z,C),w&&b.lineTo(z,C),c.lineTo(z,u),w&&b.lineTo(z,u),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(z,u),w&&
(b.stroke(),b.beginPath(),b.moveTo(z,u))));q={x:z,y:u};s<l.length-1&&(v!==(l[s].lineColor||n)||p!==(l[s].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(z,u),v=l[s].lineColor||n,c.strokeStyle=v,c.setLineDash&&(l[s].lineDashType?(p=l[s].lineDashType,c.setLineDash(G(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(f))));0!==l[s].markerSize&&(0<l[s].markerSize||0<k.markerSize)&&(C=k.getMarkerProperties(s,z,u,c),h.push(C),D=X(D),w&&h.push({x:z,y:u,ctx:b,type:C.type,size:C.size,
...
k.dataPoints,p="solid";if(b.setLineDash){var r=G(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,f=G(p,k.lineThickness);b.setLineDash(f)}var n=k.id;this._eventManager.objectMap[n]={objectType:"dataSeries",dataSeriesIndex:d};n=X(n);e.strokeStyle=n;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var n=k._colorSet,v=n=k.lineColor=k.options.lineColor?k.options.lineColor:n[0];b.strokeStyle=n;var x=0,s,z,u=[];b.beginPath();if(0<l.length)for(z=!1,x=0;x<l.length;x++)if(s=l[x].getTime?
l[x].x.getTime():l[x].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof l[x].y)0<x&&!z&&(k.connectNullData?b.setLineDash&&(0<u.length&&(k.options.nullDataLineDashType||!l[x-1].lineDashType))&&(u[u.length-1].newLineDashArray=r,p=k.nullDataLineDashType):(g(u),u=[])),z=!0;else{s=a.axisX.convertValueToPixel(s);z=a.axisY.convertValueToPixel(l[x].y);var m=k.dataPointIds[x];this._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataSeriesIndex:d,
dataPointIndex:x,x1:s,y1:z};u[u.length]={x:s,y:z};x<l.length-1&&(v!==(l[x].lineColor||n)||p!==(l[x].lineDashType||k.lineDashType))&&(v=l[x].lineColor||n,u[u.length-1].newStrokeStyle=v,b.setLineDash&&(l[x].lineDashType?(p=l[x].lineDashType,u[u.length-1].newLineDashArray=G(p,k.lineThickness)):(p=k.lineDashType,u[u.length-1].newLineDashArray=f)));if(0!==l[x].markerSize&&(0<l[x].markerSize||0<k.markerSize)){var C=k.getMarkerProperties(x,s,z,b);q.push(C);m=X(m);w&&q.push({x:s,y:z,ctx:e,type:C.type,size:C.size,
color:m,borderColor:m,borderThickness:C.borderThickness})}(l[x].indexLabel||k.indexLabel||l[x].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:l[x],dataSeries:k,point:{x:s,y:z},direction:0>l[x].y===a.axisY.reversed?1:-1,color:n});z=!1}g(u)}W.drawMarkers(q);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(l=0;l<a.dataSeriesIndexes.length;l++){var r=a.dataSeriesIndexes[l],f=this.data[r],n=f.dataPoints;if(0<n.length)for(var v=5<p&&f.bevelEnabled?!0:!1,h=0;h<n.length;h++)if(n[h].getTime?d=n[h].x.getTime():d=n[h].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[h].y){q=a.axisX.convertValueToPixel(d);y=a.axisY.convertValueToPixel(n[h].y);
q=a.axisX.reversed?q+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+l)*p<<0:q-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+l)*p<<0;var x=a.axisX.reversed?q-p<<0:q+p<<0,s;0<=n[h].y?s=k:(s=y,y=k);y>s&&(b=y,y=s,s=b);b=n[h].color?n[h].color:f._colorSet[h%f._colorSet.length];aa(c,a.axisX.reversed?x:q,y,a.axisX.reversed?q:x,s,b,0,null,v&&(a.axisY.reversed?0>n[h].y:0<=n[h].y),(a.axisY.reversed?0<=n[h].y:0>n[h].y)&&v,!1,!1,f.fillOpacity);b=f.dataPointIds[h];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:h,x1:q,y1:y,x2:x,y2:s};b=X(b);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?x:q,y,a.axisX.reversed?q:x,s,b,0,null,!1,!1,!1,!1);(n[h].indexLabel||f.indexLabel||n[h].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:n[h],dataSeries:f,point:{x:q+(x-q)/2,y:0>n[h].y===a.axisY.reversed?y:s},direction:0>n[h].y===a.axisY.reversed?1:-1,bounds:{x1:q,y1:Math.min(y,s),x2:x,y2:Math.max(y,s)},color:b})}}w&&
...
else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)d[b]=s[k].y+(d[b]?d[b]:0),m=a.axisY.convertValueToPixel(d[b]),p="undefined"!==typeof q[b]?q[b]:r,q[b]=m;else if(p=a.axisY.convertValueToPixel(s[k].y),0<=s[k].y){var C="undefined"!==typeof h[b]?h[b]:0;p-=C;m=r-C;h[b]=C+(m-p)}else C=q[b]?q[b]:0,m=p+C,p=r+C,q[b]=C+(m-p);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,l,a.axisY.reversed?m:p,u,a.axisY.reversed?p:m,b,0,null,z&&(a.axisY.reversed?0>s[k].y:0<=
...
c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:r<a.axisY.bounds.y1?a.axisY.bounds.y1:r>a.axisY.bounds.y2?a.axisY.bounds.y2:r}}};m.prototype.renderStackedColumn100=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=[],q=[],y=[],d=[],k=0,l,p,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
...
0<s[k].y){y[b]=p+("undefined"!==typeof y[b]?y[b]:0);if(0>=y[b])continue;p=a.axisY.convertValueToPixel(y[b]);t=h[b]?h[b]:r;h[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)d[b]=p+("undefined"!==typeof d[b]?d[b]:0),t=a.axisY.convertValueToPixel(d[b]),p=q[b]?q[b]:r,q[b]=t;else if(p=a.axisY.convertValueToPixel(p),0<=s[k].y){var C="undefined"!==typeof h[b]?h[b]:0;p-=C;t=r-C;a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.y1-p)&&(p=e.y1);h[b]=C+(t-p)}else C="undefined"!==
typeof q[b]?q[b]:0,t=p+C,p=r+C,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.y2-t)&&(t=e.y2),q[b]=C+(t-p);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,l,a.axisY.reversed?t:p,u,a.axisY.reversed?p:t,b,0,null,m&&(a.axisY.reversed?0>s[k].y:0<=s[k].y),(a.axisY.reversed?0<=s[k].y:0>s[k].y)&&m,!1,!1,x.fillOpacity);b=x.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:k,x1:l,y1:p,x2:u,y2:t};b=X(b);w&&aa(this._eventManager.ghostCtx,
...
this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:r<a.axisY.bounds.y1?a.axisY.bounds.y1:r>a.axisY.bounds.y2?a.axisY.bounds.y2:r}}};m.prototype.renderBar=
function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=0,q,d,n,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<
...
h);p>l&&(p=l);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(l=0;l<a.dataSeriesIndexes.length;l++){var r=a.dataSeriesIndexes[l],f=this.data[r],m=f.dataPoints;if(0<m.length){var v=5<p&&f.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<m.length;h++)if(m[h].getTime?n=m[h].x.getTime():n=m[h].x,!(n<
a.axisX.dataInfo.viewPortMin||n>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[h].y){d=a.axisX.convertValueToPixel(n);q=a.axisY.convertValueToPixel(m[h].y);d=a.axisX.reversed?d+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+l)*p<<0:d-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+l)*p<<0;var x=a.axisX.reversed?d-p<<0:d+p<<0,s;0<=m[h].y?s=k:(s=q,q=k);b=m[h].color?m[h].color:f._colorSet[h%f._colorSet.length];aa(c,a.axisY.reversed?q:s,a.axisX.reversed?x:d,a.axisY.reversed?s:
q,a.axisX.reversed?d:x,b,0,null,v,!1,!1,!1,f.fillOpacity);b=f.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:h,x1:s,y1:d,x2:q,y2:x};b=X(b);w&&aa(this._eventManager.ghostCtx,s,a.axisX.reversed?x:d,q,a.axisX.reversed?d:x,b,0,null,!1,!1,!1,!1);(m[h].indexLabel||f.indexLabel||m[h].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:m[h],dataSeries:f,point:{x:0<=m[h].y?q:s,y:d+(x-d)/2},direction:0>
m[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(s,q),y1:d,x2:Math.max(s,q),y2:x},color:b})}}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),
this._eventManager.ghostCtx.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:k<a.axisY.bounds.x1?a.axisY.bounds.x1:k>a.axisY.bounds.x2?a.axisY.bounds.x2:k}}};m.prototype.renderStackedBar=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=[],q=[],d=[],n=[],k=0,l,p,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
0<s[k].y)d[b]=s[k].y+(d[b]?d[b]:0),0<d[b]&&(t=h[b]?h[b]:r,h[b]=l=a.axisY.convertValueToPixel(d[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)n[b]=s[k].y+(n[b]?n[b]:0),l=q[b]?q[b]:r,q[b]=t=a.axisY.convertValueToPixel(n[b]);else if(l=a.axisY.convertValueToPixel(s[k].y),0<=s[k].y){var C=h[b]?h[b]:0;t=r+C;l+=C;h[b]=C+(l-t)}else C=q[b]?q[b]:0,t=l-C,l=r-C,q[b]=C+(l-t);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,a.axisY.reversed?l:t,p,a.axisY.reversed?
...
return{source:g,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:r<a.axisY.bounds.x1?a.axisY.bounds.x1:r>a.axisY.bounds.x2?a.axisY.bounds.x2:r}}};m.prototype.renderStackedBar100=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=[],q=[],d=[],n=[],k=0,l,p,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?
...
0<s[k].y){d[b]=u+(d[b]?d[b]:0);if(0>=d[b])continue;u=h[b]?h[b]:r;h[b]=l=a.axisY.convertValueToPixel(d[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[k].y)n[b]=u+(n[b]?n[b]:0),l=q[b]?q[b]:r,q[b]=u=a.axisY.convertValueToPixel(n[b]);else if(l=a.axisY.convertValueToPixel(u),0<=s[k].y){var C=h[b]?h[b]:0;u=r+C;l+=C;a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x2-l)&&(l=e.x2);h[b]=C+(l-u)}else C=q[b]?q[b]:0,u=l-C,l=r-C,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x1-
u)&&(u=e.x1),q[b]=C+(l-u);b=s[k].color?s[k].color:x._colorSet[k%x._colorSet.length];aa(c,a.axisY.reversed?l:u,p,a.axisY.reversed?u:l,t,b,0,null,z,!1,!1,!1,x.fillOpacity);b=x.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:k,x1:u,y1:p,x2:l,y2:t};b=X(b);w&&aa(this._eventManager.ghostCtx,u,p,l,t,b,0,null,!1,!1,!1,!1);(s[k].indexLabel||x.indexLabel||s[k].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",
...
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:r<a.axisY.bounds.x1?a.axisY.bounds.x1:r>a.axisY.bounds.x2?a.axisY.bounds.x2:r}}};m.prototype.renderArea=function(a){var g,c;function b(){C&&(0<f.lineThickness&&h.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?t=u:0>a.axisY.viewportMaximum?
t=d.y1:0<a.axisY.viewportMinimum&&(t=u),h.lineTo(x,t),h.lineTo(C.x,t),h.closePath(),h.globalAlpha=f.fillOpacity,h.fill(),h.globalAlpha=1,w&&(q.lineTo(x,t),q.lineTo(C.x,t),q.closePath(),q.fill()),h.beginPath(),h.moveTo(x,s),q.beginPath(),q.moveTo(x,s),C={x:x,y:s})}var e=a.targetCanvasCtx||this.plotArea.ctx,h=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var q=this._eventManager.ghostCtx,d=a.axisY.lineCoordinates,n=[],k=this.plotArea,l;h.save();w&&q.save();h.beginPath();h.rect(k.x1,k.y1,
k.width,k.height);h.clip();w&&(q.beginPath(),q.rect(k.x1,k.y1,k.width,k.height),q.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var r=a.dataSeriesIndexes[p],f=this.data[r],m=f.dataPoints,n=f.id;this._eventManager.objectMap[n]={objectType:"dataSeries",dataSeriesIndex:r};n=X(n);q.fillStyle=n;n=[];g=!0;var v=0,x,s,z,u=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),t,C=null;if(0<m.length){var D=f._colorSet[v%f._colorSet.length],B=f.lineColor=f.options.lineColor||D,
...
g||ba?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||c===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=x,c=s,x=l.x,s=l.y,b(),h.moveTo(l.x,l.y),x=g,s=c,C=l,c=f.nullDataLineDashType,h.setLineDash(J)),h.lineTo(x,s),w&&q.lineTo(x,s)):(h.beginPath(),h.moveTo(x,s),w&&(q.beginPath(),q.moveTo(x,s)),C={x:x,y:s}),ba=g=!1):(h.lineTo(x,s),w&&q.lineTo(x,s),0==v%250&&b());l={x:x,y:s};v<m.length-1&&(A!==(m[v].lineColor||B)||c!==(m[v].lineDashType||f.lineDashType))&&(b(),A=
m[v].lineColor||B,h.strokeStyle=A,h.setLineDash&&(m[v].lineDashType?(c=m[v].lineDashType,h.setLineDash(G(c,f.lineThickness))):(c=f.lineDashType,h.setLineDash(U))));var Z=f.dataPointIds[v];this._eventManager.objectMap[Z]={id:Z,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:v,x1:x,y1:s};0!==m[v].markerSize&&(0<m[v].markerSize||0<f.markerSize)&&(z=f.getMarkerProperties(v,x,s,h),n.push(z),Z=X(Z),w&&n.push({x:x,y:s,ctx:q,type:z.type,size:z.size,color:Z,borderColor:Z,borderThickness:z.borderThickness}));
...
w&&(e.lineTo(c[c.length-1].x,x),e.lineTo(s.x,x),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,h=a.axisY.lineCoordinates,q=[],d=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(d.x1,d.y1,d.width,d.height);b.clip();w&&(e.beginPath(),e.rect(d.x1,d.y1,d.width,d.height),e.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var k=a.dataSeriesIndexes[n],l=this.data[k],p=l.dataPoints,
q=l.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:k};q=X(q);e.fillStyle=q;var q=[],r=0,f,m,v=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x,s=null,z=[];if(0<p.length){var u=l._colorSet[r%l._colorSet.length],B=l.lineColor=l.options.lineColor||u,C=B;b.fillStyle=u;b.strokeStyle=B;b.lineWidth=l.lineThickness;var D="solid";if(b.setLineDash){var A=G(l.nullDataLineDashType,l.lineThickness),D=l.lineDashType,db=G(D,l.lineThickness);b.setLineDash(db)}for(m=
!1;r<p.length;r++)if(f=p[r].x.getTime?p[r].x.getTime():p[r].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!m)))if("number"!==typeof p[r].y)0<r&&!m&&(l.connectNullData?b.setLineDash&&(0<z.length&&(l.options.nullDataLineDashType||!p[r-1].lineDashType))&&(z[z.length-1].newLineDashArray=A,D=l.nullDataLineDashType):(g(),z=[])),m=!0;else{f=a.axisX.convertValueToPixel(f);m=a.axisY.convertValueToPixel(p[r].y);var J=l.dataPointIds[r];this._eventManager.objectMap[J]=
{id:J,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:r,x1:f,y1:m};z[z.length]={x:f,y:m};r<p.length-1&&(C!==(p[r].lineColor||B)||D!==(p[r].lineDashType||l.lineDashType))&&(C=p[r].lineColor||B,z[z.length-1].newStrokeStyle=C,b.setLineDash&&(p[r].lineDashType?(D=p[r].lineDashType,z[z.length-1].newLineDashArray=G(D,l.lineThickness)):(D=l.lineDashType,z[z.length-1].newLineDashArray=db)));if(0!==p[r].markerSize&&(0<p[r].markerSize||0<l.markerSize)){var U=l.getMarkerProperties(r,f,m,b);q.push(U);
J=X(J);w&&q.push({x:f,y:m,ctx:e,type:U.type,size:U.size,color:J,borderColor:J,borderThickness:U.borderThickness})}(p[r].indexLabel||l.indexLabel||p[r].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[r],dataSeries:l,point:{x:f,y:m},direction:0>p[r].y===a.axisY.reversed?1:-1,color:u});m=!1}g();W.drawMarkers(q)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,
...
d=a.axisY.lineCoordinates,n=[],k=this.plotArea,l;h.save();w&&q.save();h.beginPath();h.rect(k.x1,k.y1,k.width,k.height);h.clip();w&&(q.beginPath(),q.rect(k.x1,k.y1,k.width,k.height),q.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var r=a.dataSeriesIndexes[p],f=this.data[r],m=f.dataPoints,n=f.id;this._eventManager.objectMap[n]={objectType:"dataSeries",dataSeriesIndex:r};n=X(n);q.fillStyle=n;n=[];g=!0;var v=0,x,s,z,u=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
...
(c||g)||b(),c=!0):(x=a.axisX.convertValueToPixel(z),s=a.axisY.convertValueToPixel(m[v].y),g||c?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||J===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=x,c=s,x=l.x,s=l.y,b(),h.moveTo(l.x,l.y),x=g,s=c,C=l,J=f.nullDataLineDashType,h.setLineDash(U)),h.lineTo(x,Z),h.lineTo(x,s),w&&(q.lineTo(x,Z),q.lineTo(x,s))):(h.beginPath(),h.moveTo(x,s),w&&(q.beginPath(),q.moveTo(x,s)),C={x:x,y:s}),c=g=!1):(h.lineTo(x,Z),w&&q.lineTo(x,
Z),h.lineTo(x,s),w&&q.lineTo(x,s),0==v%250&&b()),l={x:x,y:s},v<m.length-1&&(A!==(m[v].lineColor||B)||J!==(m[v].lineDashType||f.lineDashType))&&(b(),A=m[v].lineColor||B,h.strokeStyle=A,h.setLineDash&&(m[v].lineDashType?(J=m[v].lineDashType,h.setLineDash(G(J,f.lineThickness))):(J=f.lineDashType,h.setLineDash(ba)))),z=f.dataPointIds[v],this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:v,x1:x,y1:s},0!==m[v].markerSize&&(0<m[v].markerSize||0<f.markerSize)&&(Z=
f.getMarkerProperties(v,x,s,h),n.push(Z),z=X(z),w&&n.push({x:x,y:s,ctx:q,type:Z.type,size:Z.size,color:z,borderColor:z,borderThickness:Z.borderThickness})),(m[v].indexLabel||f.indexLabel||m[v].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:m[v],dataSeries:f,point:{x:x,y:s},direction:0>m[v].y===a.axisY.reversed?1:-1,color:D}))}b();W.drawMarkers(n)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),h.globalCompositeOperation="source-atop",
...
D.connectNullData?(b.setLineDash&&(D.options.nullDataLineDashType||u===D.lineDashType&&D.lineDashType!==D.nullDataLineDashType)&&(z=k.pop(),u=k[k.length-1],g(),b.moveTo(s.x,s.y),k.push(u),k.push(z),u=D.nullDataLineDashType,b.setLineDash(U)),b.lineTo(f,m),w&&x.lineTo(f,m)):(b.beginPath(),b.moveTo(f,m),w&&(x.beginPath(),x.moveTo(f,m))),Z=z=!1):(b.lineTo(f,m),w&&x.lineTo(f,m),0==r%250&&(g(),b.moveTo(f,m),w&&x.moveTo(f,m),k.push({x:f,y:v-oa})));s={x:f,y:m};r<B.length-1&&(J!==(B[r].lineColor||A)||u!==
(B[r].lineDashType||D.lineDashType))&&(g(),b.beginPath(),b.moveTo(f,m),k.push({x:f,y:v-oa}),J=B[r].lineColor||A,b.strokeStyle=J,b.setLineDash&&(B[r].lineDashType?(u=B[r].lineDashType,b.setLineDash(G(u,D.lineThickness))):(u=D.lineDashType,b.setLineDash(ba))));if(0<=D.dataPointIndexes[h]){var ka=D.dataPointIds[D.dataPointIndexes[h]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:D.dataPointIndexes[h],x1:f,y1:m}}0<=D.dataPointIndexes[h]&&0!==ga.markerSize&&
(0<ga.markerSize||0<D.markerSize)&&(oa=D.getMarkerProperties(D.dataPointIndexes[h],f,m,b),q.push(oa),h=X(ka),w&&q.push({x:f,y:m,ctx:x,type:oa.type,size:oa.size,color:h,borderColor:h,borderThickness:oa.borderThickness}));(ga.indexLabel||D.indexLabel||ga.indexLabelFormatter||D.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ga,dataSeries:D,point:{x:f,y:m},direction:0>ga.y===a.axisY.reversed?1:-1,color:e})}}g();b.moveTo(f,m);w&&x.moveTo(f,m)}delete D.dataPointIndexes}W.drawMarkers(q);
...
m))),Z=x=!1):(b.lineTo(f,m),w&&u.lineTo(f,m),0==r%250&&(g(),b.moveTo(f,m),w&&u.moveTo(f,m),k.push({x:f,y:z-ka})));v={x:f,y:m};r<B.length-1&&(J!==(B[r].lineColor||A)||s!==(B[r].lineDashType||D.lineDashType))&&(g(),b.beginPath(),b.moveTo(f,m),k.push({x:f,y:z-ka}),J=B[r].lineColor||A,b.strokeStyle=J,b.setLineDash&&(B[r].lineDashType?(s=B[r].lineDashType,b.setLineDash(G(s,D.lineThickness))):(s=D.lineDashType,b.setLineDash(ba))));if(0<=D.dataPointIndexes[h]){var E=D.dataPointIds[D.dataPointIndexes[h]];
...
0,0,this.width,this.height),b.clearRect(q.x1,q.y1,q.width,q.height),u.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,h,q;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var d=-Infinity,n=Infinity,k=0;k<a.dataSeriesIndexes.length;k++)for(var l=a.dataSeriesIndexes[k],p=this.data[l],r=p.dataPoints,f=0,e=0;e<r.length;e++)h=r[e].getTime?h=r[e].x.getTime():h=r[e].x,h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax||"undefined"===typeof r[e].z||(f=r[e].z,f>d&&(d=f),f<n&&(n=f));for(var m=25*Math.PI,v=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,
m),k=0;k<a.dataSeriesIndexes.length;k++)if(l=a.dataSeriesIndexes[k],p=this.data[l],r=p.dataPoints,0<r.length)for(c.strokeStyle="#4572A7 ",e=0;e<r.length;e++)if(h=r[e].getTime?h=r[e].x.getTime():h=r[e].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[e].y){h=a.axisX.convertValueToPixel(h);q=a.axisY.convertValueToPixel(r[e].y);var f=r[e].z,x=2*Math.max(Math.sqrt((d===n?v/2:m+(v-m)/(d-n)*(f-n))/Math.PI)<<0,1),f=p.getMarkerProperties(e,c);f.size=x;c.globalAlpha=
p.fillOpacity;W.drawMarker(h,q,c,f.type,f.size,f.color,f.borderColor,f.borderThickness);c.globalAlpha=1;var s=p.dataPointIds[e];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:e,x1:h,y1:q,size:x};x=X(s);w&&W.drawMarker(h,q,this._eventManager.ghostCtx,f.type,f.size,x,x,f.borderThickness);(r[e].indexLabel||p.indexLabel||r[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:r[e],dataSeries:p,point:{x:h,y:q},
direction:1,bounds:{x1:h-f.size/2,y1:q-f.size/2,x2:h+f.size/2,y2:q+f.size/2},color:null})}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());
...
b.width,b.height),this._eventManager.ghostCtx.clip());for(var d=0;d<a.dataSeriesIndexes.length;d++){var n=a.dataSeriesIndexes[d],k=this.data[n],l=k.dataPoints;if(0<l.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var p=0,r=0,e=0;e<l.length;e++)if(h=l[e].getTime?h=l[e].x.getTime():h=l[e].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&"number"===typeof l[e].y){h=a.axisX.convertValueToPixel(h);q=a.axisY.convertValueToPixel(l[e].y);var f=k.getMarkerProperties(e,
h,q,c);c.globalAlpha=k.fillOpacity;W.drawMarker(f.x,f.y,f.ctx,f.type,f.size,f.color,f.borderColor,f.borderThickness);c.globalAlpha=1;Math.sqrt((p-h)*(p-h)+(r-q)*(r-q))<Math.min(f.size,5)&&l.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:h,y1:q},p=X(p),w&&W.drawMarker(f.x,f.y,this._eventManager.ghostCtx,f.type,f.size,p,p,f.borderThickness),(l[e].indexLabel||k.indexLabel||
l[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:l[e],dataSeries:k,point:{x:h,y:q},direction:1,bounds:{x1:h-f.size/2,y1:q-f.size/2,x2:h+f.size/2,y2:q+f.size/2},color:null}),p=h,r=q)}}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
null,h=null,q=this.plotArea,d=0,m,k,l,p,r,f,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,h=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,t=a.axisX.dataInfo.minDiff;isFinite(t)||(t=0.3*Math.abs(a.axisX.range));t=this.options.dataPointWidth?this.dataPointWidth:0.7*q.width*(a.axisX.logarithmic?Math.log(t)/Math.log(a.axisX.range):Math.abs(t)/Math.abs(a.axisX.range))<<0;
this.dataPointMaxWidth&&e>h&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,h));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&h<e)&&(h=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>h&&(t=h);c.save();w&&b.save();c.beginPath();c.rect(q.x1,q.y1,q.width,q.height);c.clip();w&&(b.beginPath(),b.rect(q.x1,q.y1,q.width,q.height),b.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var x=a.dataSeriesIndexes[v],s=this.data[x],z=s.dataPoints;
if(0<z.length)for(var u=5<t&&s.bevelEnabled?!0:!1,d=0;d<z.length;d++)if(z[d].getTime?f=z[d].x.getTime():f=z[d].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&!n(z[d].y)&&z[d].y.length&&"number"===typeof z[d].y[0]&&"number"===typeof z[d].y[1]&&"number"===typeof z[d].y[2]&&"number"===typeof z[d].y[3]){m=a.axisX.convertValueToPixel(f);k=a.axisY.convertValueToPixel(z[d].y[0]);l=a.axisY.convertValueToPixel(z[d].y[1]);p=a.axisY.convertValueToPixel(z[d].y[2]);r=a.axisY.convertValueToPixel(z[d].y[3]);
var B=m-t/2<<0,C=B+t<<0,h=s.options.fallingColor?s.fallingColor:s._colorSet[0],e=z[d].color?z[d].color:s._colorSet[0],D=Math.round(Math.max(1,0.15*t)),A=0===D%2?0:0.5,G=s.dataPointIds[d];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:d,x1:B,y1:k,x2:C,y2:l,x3:m,y3:p,x4:m,y4:r,borderThickness:D,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=D;b.lineWidth=Math.max(D,4);"candlestick"===s.type?(c.moveTo(m-A,l),c.lineTo(m-A,Math.min(k,r)),c.stroke(),c.moveTo(m-
A,Math.max(k,r)),c.lineTo(m-A,p),c.stroke(),aa(c,B,Math.min(k,r),C,Math.max(k,r),z[d].y[0]<=z[d].y[3]?s.risingColor:h,D,e,u,u,!1,!1,s.fillOpacity),w&&(e=X(G),b.strokeStyle=e,b.moveTo(m-A,l),b.lineTo(m-A,Math.min(k,r)),b.stroke(),b.moveTo(m-A,Math.max(k,r)),b.lineTo(m-A,p),b.stroke(),aa(b,B,Math.min(k,r),C,Math.max(k,r),e,0,null,!1,!1,!1,!1))):"ohlc"===s.type&&(c.moveTo(m-A,l),c.lineTo(m-A,p),c.stroke(),c.beginPath(),c.moveTo(m,k),c.lineTo(B,k),c.stroke(),c.beginPath(),c.moveTo(m,r),c.lineTo(C,r),
c.stroke(),w&&(e=X(G),b.strokeStyle=e,b.moveTo(m-A,l),b.lineTo(m-A,p),b.stroke(),b.beginPath(),b.moveTo(m,k),b.lineTo(B,k),b.stroke(),b.beginPath(),b.moveTo(m,r),b.lineTo(C,r),b.stroke()));(z[d].indexLabel||s.indexLabel||z[d].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:s.type,dataPoint:z[d],dataSeries:s,point:{x:B+(C-B)/2,y:a.axisY.reversed?p:l},direction:1,bounds:{x1:B,y1:Math.min(l,p),x2:C,y2:Math.max(l,p)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,0,
this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(q.x1,q.y1,q.width,q.height),b.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,
animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,h=this.plotArea,q=0,d,m,k,l,p,r,f,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,q=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,t=a.axisX.dataInfo.minDiff;isFinite(t)||
(t=0.3*Math.abs(a.axisX.range));t=this.options.dataPointWidth?this.dataPointWidth:0.7*h.width*(a.axisX.logarithmic?Math.log(t)/Math.log(a.axisX.range):Math.abs(t)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>q&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,q));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&q<e)&&(q=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>q&&(t=q);c.save();w&&b.save();c.beginPath();c.rect(h.x1,h.y1,h.width,
h.height);c.clip();w&&(b.beginPath(),b.rect(h.x1,h.y1,h.width,h.height),b.clip());for(var v=!1,v=!!a.axisY.reversed,x=0;x<a.dataSeriesIndexes.length;x++){var s=a.dataSeriesIndexes[x],z=this.data[s],u=z.dataPoints;if(0<u.length)for(var B=5<t&&z.bevelEnabled?!0:!1,q=0;q<u.length;q++)if(u[q].getTime?f=u[q].x.getTime():f=u[q].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&!n(u[q].y)&&u[q].y.length&&"number"===typeof u[q].y[0]&&"number"===typeof u[q].y[1]&&"number"===typeof u[q].y[2]&&
"number"===typeof u[q].y[3]&&"number"===typeof u[q].y[4]&&5===u[q].y.length){d=a.axisX.convertValueToPixel(f);m=a.axisY.convertValueToPixel(u[q].y[0]);k=a.axisY.convertValueToPixel(u[q].y[1]);l=a.axisY.convertValueToPixel(u[q].y[2]);p=a.axisY.convertValueToPixel(u[q].y[3]);r=a.axisY.convertValueToPixel(u[q].y[4]);var C=d-t/2<<0,D=d+t/2<<0,e=u[q].color?u[q].color:z._colorSet[0],A=Math.round(Math.max(1,0.15*t)),H=0===A%2?0:0.5,J=u[q].whiskerColor?u[q].whiskerColor:u[q].color?z.whiskerColor?z.whiskerColor:
u[q].color:z.whiskerColor?z.whiskerColor:e,U="number"===typeof u[q].whiskerThickness?u[q].whiskerThickness:"number"===typeof z.options.whiskerThickness?z.whiskerThickness:A,ba=u[q].whiskerDashType?u[q].whiskerDashType:z.whiskerDashType,Z=n(u[q].whiskerLength)?n(z.options.whiskerLength)?t:z.whiskerLength:u[q].whiskerLength,Z="number"===typeof Z?0>=Z?0:Z>=t?t:Z:"string"===typeof Z?parseInt(Z)*t/100>t?t:parseInt(Z)*t/100:t,ga=1===Math.round(U)%2?0.5:0,oa=u[q].stemColor?u[q].stemColor:u[q].color?z.stemColor?
z.stemColor:u[q].color:z.stemColor?z.stemColor:e,ka="number"===typeof u[q].stemThickness?u[q].stemThickness:"number"===typeof z.options.stemThickness?z.stemThickness:A,E=1===Math.round(ka)%2?0.5:0,L=u[q].stemDashType?u[q].stemDashType:z.stemDashType,O=u[q].lineColor?u[q].lineColor:u[q].color?z.lineColor?z.lineColor:u[q].color:z.lineColor?z.lineColor:e,Q="number"===typeof u[q].lineThickness?u[q].lineThickness:"number"===typeof z.options.lineThickness?z.lineThickness:A,P=u[q].lineDashType?u[q].lineDashType:
z.lineDashType,M=1===Math.round(Q)%2?0.5:0,N=z.upperBoxColor,S=z.lowerBoxColor,ta=n(z.options.fillOpacity)?1:z.fillOpacity,R=z.dataPointIds[q];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:q,x1:C,y1:m,x2:D,y2:k,x3:d,y3:l,x4:d,y4:p,y5:r,borderThickness:A,color:e,stemThickness:ka,stemColor:oa,whiskerThickness:U,whiskerLength:Z,whiskerColor:J,lineThickness:Q,lineColor:O};c.save();0<ka&&(c.beginPath(),c.strokeStyle=oa,c.lineWidth=ka,c.setLineDash&&c.setLineDash(G(L,
ka)),c.moveTo(d-E,k),c.lineTo(d-E,m),c.stroke(),c.moveTo(d-E,p),c.lineTo(d-E,l),c.stroke());c.restore();b.lineWidth=Math.max(A,4);c.beginPath();aa(c,C,Math.min(r,k),D,Math.max(k,r),S,0,e,v?B:!1,v?!1:B,!1,!1,ta);c.beginPath();aa(c,C,Math.min(l,r),D,Math.max(r,l),N,0,e,v?!1:B,v?B:!1,!1,!1,ta);c.beginPath();c.lineWidth=A;c.strokeStyle=e;c.rect(C-H,Math.min(k,l)-H,D-C+2*H,Math.max(k,l)-Math.min(k,l)+2*H);c.stroke();c.save();0<Q&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(G(P,Q)),c.strokeStyle=
O,c.lineWidth=Q,c.moveTo(C,r-M),c.lineTo(D,r-M),c.stroke());c.restore();c.save();0<U&&(c.beginPath(),c.setLineDash&&c.setLineDash(G(ba,U)),c.strokeStyle=J,c.lineWidth=U,c.moveTo(d-Z/2<<0,p-ga),c.lineTo(d+Z/2<<0,p-ga),c.stroke(),c.moveTo(d-Z/2<<0,m+ga),c.lineTo(d+Z/2<<0,m+ga),c.stroke());c.restore();w&&(e=X(R),b.strokeStyle=e,b.lineWidth=ka,0<ka&&(b.moveTo(d-H-E,k),b.lineTo(d-H-E,Math.max(m,p)),b.stroke(),b.moveTo(d-H-E,Math.min(m,p)),b.lineTo(d-H-E,l),b.stroke()),aa(b,C,Math.max(k,l),D,Math.min(k,
l),e,0,null,!1,!1,!1,!1),0<U&&(b.beginPath(),b.lineWidth=U,b.moveTo(d+Z/2,p-ga),b.lineTo(d-Z/2,p-ga),b.stroke(),b.moveTo(d+Z/2,m+ga),b.lineTo(d-Z/2,m+ga),b.stroke()));(u[q].indexLabel||z.indexLabel||u[q].indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:z.type,dataPoint:u[q],dataSeries:z,point:{x:C+(D-C)/2,y:a.axisY.reversed?m:p},direction:1,bounds:{x1:C,y1:Math.min(m,p),x2:D,y2:Math.max(m,p)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=0,q,d,m,h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;q=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.03*this.width;var k=a.axisX.dataInfo.minDiff;isFinite(k)||(k=0.3*Math.abs(a.axisX.range));k=this.options.dataPointWidth?this.dataPointWidth:
0.9*(e.width*(a.axisX.logarithmic?Math.log(k)/Math.log(a.axisX.range):Math.abs(k)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&h>q&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,q));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&q<h)&&(q=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));k<h&&(k=h);k>q&&(k=q);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var l=0;l<a.dataSeriesIndexes.length;l++){var p=a.dataSeriesIndexes[l],r=this.data[p],f=r.dataPoints;if(0<f.length)for(var t=5<k&&r.bevelEnabled?!0:!1,h=0;h<f.length;h++)if(f[h].getTime?m=f[h].x.getTime():m=f[h].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax)&&!n(f[h].y)&&f[h].y.length&&"number"===typeof f[h].y[0]&&"number"===typeof f[h].y[1]){b=a.axisX.convertValueToPixel(m);q=
a.axisY.convertValueToPixel(f[h].y[0]);d=a.axisY.convertValueToPixel(f[h].y[1]);var v=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+l)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+l)*k<<0,x=a.axisX.reversed?v-k<<0:v+k<<0,b=f[h].color?f[h].color:r._colorSet[h%r._colorSet.length];if(q>d){var s=q;q=d;d=s}s=r.dataPointIds[h];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:h,x1:v,y1:q,x2:x,y2:d};aa(c,a.axisX.reversed?
x:v,q,a.axisX.reversed?v:x,d,b,0,b,t,t,!1,!1,r.fillOpacity);b=X(s);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?x:v,q,a.axisX.reversed?v:x,d,b,0,null,!1,!1,!1,!1);if(f[h].indexLabel||r.indexLabel||f[h].indexLabelFormatter||r.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:f[h],dataSeries:r,indexKeyword:0,point:{x:v+(x-v)/2,y:f[h].y[1]>=f[h].y[0]?d:q},direction:f[h].y[1]>=f[h].y[0]?-1:1,bounds:{x1:v,y1:Math.min(q,d),x2:x,y2:Math.max(q,d)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:f[h],dataSeries:r,indexKeyword:1,point:{x:v+(x-v)/2,y:f[h].y[1]>=f[h].y[0]?q:d},direction:f[h].y[1]>=f[h].y[0]?1:-1,bounds:{x1:v,y1:Math.min(q,d),x2:x,y2:Math.max(q,d)},color:b})}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
d=0,m,k,l,p,r,f,t,v=a.axisX.dataInfo.minDiff;isFinite(v)||(v=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(q.x1,q.y1,q.width,q.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(q.x1,q.y1,q.width,q.height),this._eventManager.ghostCtx.clip());for(var x=0,s=0;s<this.data.length;s++)!this.data[s].type.match(/(bar|column)/ig)||!this.data[s].visible||this.data[s].type.match(/(stacked)/ig)&&x||x++;for(var z=0;z<
...
1;d=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(D?x:1)))<<0:0.3*this.width;h&&(d=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(D?x:1)))<<0:0.03*this.width);s=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?q.height:q.width)*(a.axisX.logarithmic?Math.log(v)/Math.log(a.axisX.range):
...
!n(C[d].y)&&C[d].y.length&&"number"===typeof C[d].y[0]&&"number"===typeof C[d].y[1]){var ba=a.axisX.convertValueToPixel(t);b?k=ba:m=ba;ba=a.axisY.convertValueToPixel(C[d].y[0]);b?l=ba:r=ba;ba=a.axisY.convertValueToPixel(C[d].y[1]);b?p=ba:f=ba;b?(r=a.axisX.reversed?k+(D?x:1)*s/2-(D?G-1:0)*s<<0:k-(D?x:1)*s/2+(D?G-1:0)*s<<0,f=a.axisX.reversed?r-s<<0:r+s<<0):(l=a.axisX.reversed?m+(D?x:1)*s/2-(D?G-1:0)*s<<0:m-(D?x:1)*s/2+(D?G-1:0)*s<<0,p=a.axisX.reversed?l-s<<0:l+s<<0);!b&&r>f&&(ba=r,r=f,f=ba);b&&l>p&&
(ba=l,l=p,p=ba);ba=A.dataPointIds[d];this._eventManager.objectMap[ba]={id:ba,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:d,x1:Math.min(l,p),y1:Math.min(r,f),x2:Math.max(p,l),y2:Math.max(f,r),isXYSwapped:b,stemProperties:U,whiskerProperties:J};B(c,Math.min(l,p),Math.min(r,f),Math.max(p,l),Math.max(f,r),e,J,U,b);w&&B(this._eventManager.ghostCtx,l,r,p,f,e,J,U,b);if(C[d].indexLabel||A.indexLabel||C[d].indexLabelFormatter||A.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:C[d],
dataSeries:A,indexKeyword:0,point:{x:b?C[d].y[1]>=C[d].y[0]?l:p:l+(p-l)/2,y:b?r+(f-r)/2:C[d].y[1]>=C[d].y[0]?f:r},direction:C[d].y[1]>=C[d].y[0]?-1:1,bounds:{x1:b?Math.min(l,p):l,y1:b?r:Math.min(r,f),x2:b?Math.max(l,p):p,y2:b?f:Math.max(r,f)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:C[d],dataSeries:A,indexKeyword:1,point:{x:b?C[d].y[1]>=C[d].y[0]?p:l:l+(p-l)/2,y:b?r+(f-r)/2:C[d].y[1]>=C[d].y[0]?r:f},direction:C[d].y[1]>=C[d].y[0]?1:-1,bounds:{x1:b?Math.min(l,p):
l,y1:b?r:Math.min(r,f),x2:b?Math.max(l,p):p,y2:b?f:Math.max(r,f)},color:e,axisSwapped:b})}}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(q.x1,q.y1,q.width,q.height),
this._eventManager.ghostCtx.restore());c.restore();return{source:g,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,h=0,q,d,m,k,h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;q=this.options.dataPointMaxWidth?
...
Infinity,q));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&q<h)&&(q=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));l<h&&(l=h);l>q&&(l=q);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var r=a.dataSeriesIndexes[p],f=this.data[r],
t=f.dataPoints;if(0<t.length){var v=5<l&&f.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(t[h].getTime?k=t[h].x.getTime():k=t[h].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!n(t[h].y)&&t[h].y.length&&"number"===typeof t[h].y[0]&&"number"===typeof t[h].y[1]){q=a.axisY.convertValueToPixel(t[h].y[0]);d=a.axisY.convertValueToPixel(t[h].y[1]);m=a.axisX.convertValueToPixel(k);m=a.axisX.reversed?m+a.plotType.totalDataSeries*l/2-(a.previousDataSeriesCount+p)*
l<<0:m-a.plotType.totalDataSeries*l/2+(a.previousDataSeriesCount+p)*l<<0;var x=a.axisX.reversed?m-l<<0:m+l<<0;q>d&&(b=q,q=d,d=b);b=t[h].color?t[h].color:f._colorSet[h%f._colorSet.length];aa(c,q,a.axisX.reversed?x:m,d,a.axisX.reversed?m:x,b,0,null,v,!1,!1,!1,f.fillOpacity);b=f.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:h,x1:q,y1:m,x2:d,y2:x};b=X(b);w&&aa(this._eventManager.ghostCtx,q,a.axisX.reversed?x:m,d,a.axisX.reversed?m:x,b,0,
null,!1,!1,!1,!1);if(t[h].indexLabel||f.indexLabel||t[h].indexLabelFormatter||f.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:t[h],dataSeries:f,indexKeyword:0,point:{x:t[h].y[1]>=t[h].y[0]?q:d,y:m+(x-m)/2},direction:t[h].y[1]>=t[h].y[0]?-1:1,bounds:{x1:Math.min(q,d),y1:m,x2:Math.max(q,d),y2:x},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:t[h],dataSeries:f,indexKeyword:1,point:{x:t[h].y[1]>=t[h].y[0]?d:q,y:m+(x-m)/2},direction:t[h].y[1]>=t[h].y[0]?1:
-1,bounds:{x1:Math.min(q,d),y1:m,x2:Math.max(q,d),y2:x},color:b})}}}w&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
...
n[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(m,v);e.beginPath();e.moveTo(m,v);z={x:m,y:v};n=[];n.push({x:m,y1:v,y2:x})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,h=[],q=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(q.x1,q.y1,q.width,q.height);b.clip();w&&(e.beginPath(),e.rect(q.x1,q.y1,q.width,q.height),e.clip());for(var d=0;d<a.dataSeriesIndexes.length;d++){var n=[],k=a.dataSeriesIndexes[d],
l=this.data[k],p=l.dataPoints,h=l.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:k};h=X(h);e.fillStyle=h;var h=[],r=!0,f=0,m,v,x,s,z=null;if(0<p.length){var u=l._colorSet[f%l._colorSet.length],t=l.lineColor=l.options.lineColor||u,C=t;b.fillStyle=u;b.strokeStyle=t;b.lineWidth=l.lineThickness;var D="solid";if(b.setLineDash){var B=G(l.nullDataLineDashType,l.lineThickness),D=l.lineDashType,A=G(D,l.lineThickness);b.setLineDash(A)}for(var J=!0;f<p.length;f++)if(s=p[f].x.getTime?
p[f].x.getTime():p[f].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!J)))if(null!==p[f].y&&p[f].y.length&&"number"===typeof p[f].y[0]&&"number"===typeof p[f].y[1]){m=a.axisX.convertValueToPixel(s);v=a.axisY.convertValueToPixel(p[f].y[0]);x=a.axisY.convertValueToPixel(p[f].y[1]);r||J?(l.connectNullData&&!r?(b.setLineDash&&(l.options.nullDataLineDashType||D===l.lineDashType&&l.lineDashType!==l.nullDataLineDashType)&&(n[n.length-1].newLineDashArray=A,D=l.nullDataLineDashType,
b.setLineDash(B)),b.lineTo(m,v),w&&e.lineTo(m,v),n.push({x:m,y1:v,y2:x})):(b.beginPath(),b.moveTo(m,v),z={x:m,y:v},n=[],n.push({x:m,y1:v,y2:x}),w&&(e.beginPath(),e.moveTo(m,v))),J=r=!1):(b.lineTo(m,v),n.push({x:m,y1:v,y2:x}),w&&e.lineTo(m,v),0==f%250&&g());s=l.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:f,x1:m,y1:v,y2:x};f<p.length-1&&(C!==(p[f].lineColor||t)||D!==(p[f].lineDashType||l.lineDashType))&&(g(),C=p[f].lineColor||t,n[n.length-
...
p[f].y[1]===a.axisY.reversed?1:-1,color:u})}else J||r||g(),J=!0;g();W.drawMarkers(h)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(q.x1,q.y1,q.width,q.height),this._eventManager.ghostCtx.restore());
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,h=[],q=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(q.x1,q.y1,q.width,q.height);b.clip();w&&(e.beginPath(),e.rect(q.x1,q.y1,q.width,q.height),e.clip());for(var d=0;d<a.dataSeriesIndexes.length;d++){var n=a.dataSeriesIndexes[d],k=this.data[n],l=k.dataPoints,h=k.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=X(h);e.fillStyle=h;var h=[],p=0,r,
f,m,v=[],x=[];if(0<l.length){var s=k._colorSet[p%k._colorSet.length],z=k.lineColor=k.options.lineColor||s,u=z;b.fillStyle=s;b.lineWidth=k.lineThickness;var A="solid",C;if(b.setLineDash){var D=G(k.nullDataLineDashType,k.lineThickness),A=k.lineDashType;C=G(A,k.lineThickness)}for(f=!1;p<l.length;p++)if(r=l[p].x.getTime?l[p].x.getTime():l[p].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!f)))if(null!==l[p].y&&l[p].y.length&&"number"===typeof l[p].y[0]&&"number"===
typeof l[p].y[1]){r=a.axisX.convertValueToPixel(r);f=a.axisY.convertValueToPixel(l[p].y[0]);m=a.axisY.convertValueToPixel(l[p].y[1]);var B=k.dataPointIds[p];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:p,x1:r,y1:f,y2:m};v[v.length]={x:r,y:f};x[x.length]={x:r,y:m};p<l.length-1&&(u!==(l[p].lineColor||z)||A!==(l[p].lineDashType||k.lineDashType))&&(u=l[p].lineColor||z,v[v.length-1].newStrokeStyle=u,b.setLineDash&&(l[p].lineDashType?(A=l[p].lineDashType,
v[v.length-1].newLineDashArray=G(A,k.lineThickness)):(A=k.lineDashType,v[v.length-1].newLineDashArray=C)));if(0!==l[p].markerSize&&(0<l[p].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(p,r,f,b);h.push(H);var J=X(B);w&&h.push({x:r,y:f,ctx:e,type:H.type,size:H.size,color:J,borderColor:J,borderThickness:H.borderThickness});H=k.getMarkerProperties(p,r,m,b);h.push(H);J=X(B);w&&h.push({x:r,y:m,ctx:e,type:H.type,size:H.size,color:J,borderColor:J,borderThickness:H.borderThickness})}if(l[p].indexLabel||
k.indexLabel||l[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:l[p],dataSeries:k,indexKeyword:0,point:{x:r,y:f},direction:l[p].y[0]<=l[p].y[1]?-1:1,color:s}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:l[p],dataSeries:k,indexKeyword:1,point:{x:r,y:m},direction:l[p].y[0]<=l[p].y[1]?1:-1,color:s});f=!1}else 0<p&&!f&&(k.connectNullData?b.setLineDash&&(0<v.length&&(k.options.nullDataLineDashType||!l[p-1].lineDashType))&&(v[v.length-
1].newLineDashArray=D,A=k.nullDataLineDashType):(g(C,z),v=[],x=[])),f=!0;g(C,z);W.drawMarkers(h)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(q.x1,q.y1,q.width,q.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,h=this.plotArea,q=0,d,n,k,l,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),q=this.options.dataPointMinWidth?this.dataPointMinWidth:
this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0;var r=a.axisX.dataInfo.minDiff;isFinite(r)||(r=0.3*Math.abs(a.axisX.range));r=this.options.dataPointWidth?this.dataPointWidth:0.6*(h.width*(a.axisX.logarithmic?Math.log(r)/Math.log(a.axisX.range):Math.abs(r)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&
q>n&&(q=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<q)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,q));r<q&&(r=q);r>n&&(r=n);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(h.x1,h.y1,h.width,h.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.clip());for(var f=0;f<a.dataSeriesIndexes.length;f++){var m=
a.dataSeriesIndexes[f],v=this.data[m],x=v.dataPoints,e=v._colorSet[0];v.risingColor=v.options.risingColor?v.options.risingColor:e;v.fallingColor=v.options.fallingColor?v.options.fallingColor:"#e40a0a";var s="number"===typeof v.options.lineThickness?Math.round(v.lineThickness):1,z=1===Math.round(s)%2?-0.5:0;if(0<x.length)for(var u=5<r&&v.bevelEnabled?!0:!1,t=!1,C=null,D=null,q=0;q<x.length;q++)if(x[q].getTime?l=x[q].x.getTime():l=x[q].x,"number"!==typeof x[q].y){if(0<q&&!t&&v.connectNullData)var A=
v.options.nullDataLineDashType||!x[q-1].lineDashType?v.nullDataLineDashType:x[q-1].lineDashType;t=!0}else{d=a.axisX.convertValueToPixel(l);n=0===v.dataPointEOs[q].cumulativeSum?p:a.axisY.convertValueToPixel(v.dataPointEOs[q].cumulativeSum);k=0===v.dataPointEOs[q].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(v.dataPointEOs[q].cumulativeSumYStartValue);d=a.axisX.reversed?d+a.plotType.totalDataSeries*r/2-(a.previousDataSeriesCount+f)*r<<0:d-a.plotType.totalDataSeries*r/2+(a.previousDataSeriesCount+
f)*r<<0;var B=a.axisX.reversed?d-r<<0:d+r<<0;n>k&&(e=n,n=k,k=e);a.axisY.reversed&&(e=n,n=k,k=e);e=v.dataPointIds[q];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:q,x1:d,y1:n,x2:B,y2:k};var J=x[q].color?x[q].color:0<x[q].y?v.risingColor:v.fallingColor;aa(c,a.axisX.reversed?B:d,a.axisY.reversed?k:n,a.axisX.reversed?d:B,a.axisY.reversed?n:k,J,0,J,u,u,!1,!1,v.fillOpacity);e=X(e);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?B:d,n,a.axisX.reversed?d:
B,k,e,0,null,!1,!1,!1,!1);var U,J=d;U="undefined"!==typeof x[q].isIntermediateSum&&!0===x[q].isIntermediateSum||"undefined"!==typeof x[q].isCumulativeSum&&!0===x[q].isCumulativeSum?0<x[q].y?n:k:0<x[q].y?k:n;0<q&&C&&(!t||v.connectNullData)&&(t&&c.setLineDash&&c.setLineDash(G(A,s)),c.beginPath(),c.moveTo(C,D-z),c.lineTo(J,U-z),0<s&&c.stroke(),w&&(b.beginPath(),b.moveTo(C,D-z),b.lineTo(J,U-z),0<s&&b.stroke()));t=!1;C=B;D=0<x[q].y?n:k;J=x[q].lineDashType?x[q].lineDashType:v.options.lineDashType?v.options.lineDashType:
"shortDash";c.strokeStyle=x[q].lineColor?x[q].lineColor:v.options.lineColor?v.options.lineColor:"#9e9e9e";c.lineWidth=s;c.setLineDash&&(J=G(J,s),c.setLineDash(J));(x[q].indexLabel||v.indexLabel||x[q].indexLabelFormatter||v.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:x[q],dataSeries:v,point:{x:d+(B-d)/2,y:0<=x[q].y?n:k},direction:0>x[q].y===a.axisY.reversed?1:-1,bounds:{x1:d,y1:Math.min(n,k),x2:B,y2:Math.max(n,k)},color:e})}}w&&(g.drawImage(this._preRenderCanvas,0,
...
animationBase:0}}};var ia=function(a,g,c,b,e,h,q,d,n){if(!(0>c)){"undefined"===typeof d&&(d=1);if(!w){var k=Number((q%(2*Math.PI)).toFixed(8));Number((h%(2*Math.PI)).toFixed(8))===k&&(q-=1E-4)}a.save();a.globalAlpha=d;"pie"===e?(a.beginPath(),a.moveTo(g.x,g.y),a.arc(g.x,g.y,c,h,q,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(g.x,g.y,c,h,q,!1),0<=n&&a.arc(g.x,g.y,n*c,q,h,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function g(){if(k&&l){var a=0,b=0,c=0,e=0;n(k.options.indexLabelMaxWidth)&&(k.indexLabelMaxWidth=0.33*r.width);for(var g=0;g<l.length;g++){var h=l[g],q=k.dataPointIds[g];f[g].id=q;f[g].objectType="dataPoint";f[g].dataPointIndex=g;f[g].dataSeriesIndex=0;var d=f[g],p={percent:null,total:null},y=null,p=m.getPercentAndTotal(k,h);if(k.indexLabelFormatter||h.indexLabelFormatter)y={chart:m.options,dataSeries:k,dataPoint:h,total:p.total,
percent:p.percent};p=h.indexLabelFormatter?h.indexLabelFormatter(y):h.indexLabel?m.replaceKeywordsWithValue(h.indexLabel,h,k,g):k.indexLabelFormatter?k.indexLabelFormatter(y):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,h,k,g):h.label?h.label:"";m._eventManager.objectMap[q]=d;d.center={x:u.x,y:u.y};d.y=h.y;d.radius=B;d.percentInnerRadius=H;d.indexLabelText=p;d.indexLabelPlacement=k.indexLabelPlacement;d.indexLabelLineColor=h.indexLabelLineColor?h.indexLabelLineColor:k.options.indexLabelLineColor?
...
5*d.indexLabelFontSize:1.5*d.indexLabelFontSize,text:d.indexLabelText,padding:0,textBaseline:"middle"});d.indexLabelTextBlock.measureText()}q=h=0;p=!1;for(g=0;g<l.length;g++)d=f[(c+g)%l.length],1<a&&(d.midAngle>Math.PI/2-s&&d.midAngle<Math.PI/2+s)&&(h<=a/2&&!p?(d.hemisphere="right",h++):(d.hemisphere="left",p=!0));p=!1;for(g=0;g<l.length;g++)d=f[(e+g)%l.length],1<b&&(d.midAngle>3*Math.PI/2-s&&d.midAngle<3*Math.PI/2+s)&&(q<=b/2&&!p?(d.hemisphere="left",q++):(d.hemisphere="right",p=!0))}}function c(a,
b){var c=m.plotArea.ctx;c.clearRect(r.x1,r.y1,r.width,r.height);c.fillStyle=m.backgroundColor;c.fillRect(r.x1,r.y1,r.width,r.height);for(c=0;c<l.length;c++){var g=f[c].startAngle,e=f[c].endAngle;if(e>g){var h=0.07*B*Math.cos(f[c].midAngle),d=0.07*B*Math.sin(f[c].midAngle),q=!1;if(l[c].exploded){if(1E-9<Math.abs(f[c].center.x-(u.x+h))||1E-9<Math.abs(f[c].center.y-(u.y+d)))f[c].center.x=u.x+h*a,f[c].center.y=u.y+d*a,q=!0}else if(0<Math.abs(f[c].center.x-u.x)||0<Math.abs(f[c].center.y-u.y))f[c].center.x=
u.x+h*(1-a),f[c].center.y=u.y+d*(1-a),q=!0;q&&b&&(h={},h.dataSeries=k,h.dataPoint=k.dataPoints[c],h.index=c,m.toolTip.highlightObjects([h]));ia(m.plotArea.ctx,f[c].center,f[c].radius,l[c].color?l[c].color:k._colorSet[c%k._colorSet.length],k.type,g,e,k.fillOpacity,f[c].percentInnerRadius)}}c=m.plotArea.ctx;c.save();c.fillStyle="black";c.strokeStyle="grey";c.textBaseline="middle";c.lineJoin="round";for(g=g=0;g<l.length;g++)e=f[g],e.indexLabelText&&(e.indexLabelTextBlock.y-=e.indexLabelTextBlock.height/
...
else c=null;return c}function h(a,c,g){g=(g||0)+1;if(1E3<g)return 0;c=c||0;var d=0,q=u.y-1*v,k=u.y+1*v;if(0<=a&&a<l.length){var p=f[a];if(0>c&&p.indexLabelTextBlock.y<q||0<c&&p.indexLabelTextBlock.y>k)return 0;var r=0,n=0,n=r=r=0;0>c?p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2>q&&p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c<q&&(c=-(q-(p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c))):p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2<q&&p.indexLabelTextBlock.y+
p.indexLabelTextBlock.height/2+c>k&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c-k);c=p.indexLabelTextBlock.y+c;q=0;q="right"===p.hemisphere?u.x+Math.sqrt(Math.pow(v,2)-Math.pow(c-u.y,2)):u.x-Math.sqrt(Math.pow(v,2)-Math.pow(c-u.y,2));n=u.x+B*Math.cos(p.midAngle);r=u.y+B*Math.sin(p.midAngle);r=Math.sqrt(Math.pow(q-n,2)+Math.pow(c-r,2));n=Math.acos(B/v);r=Math.acos((v*v+B*B-r*r)/(2*B*v));c=r<n?c-p.indexLabelTextBlock.y:0;q=null;for(k=1;k<l.length;k++)if(q=(a-k+f.length)%f.length,f[q].hemisphere!==
f[a].hemisphere){q=null;break}else if(f[q].indexLabelText&&f[q].hemisphere===f[a].hemisphere&&q!==a&&(0>b(f[q],f[a])||("right"===f[a].hemisphere?f[q].indexLabelTextBlock.y<=f[a].indexLabelTextBlock.y:f[q].indexLabelTextBlock.y>=f[a].indexLabelTextBlock.y)))break;else q=null;n=q;r=e(a);k=q=0;0>c?(k="right"===p.hemisphere?n:r,d=c,null!==k&&(n=-c,c=p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2-(f[k].indexLabelTextBlock.y+f[k].indexLabelTextBlock.height/2),c-n<w&&(q=-n,k=h(k,q,g+1),+k.toFixed(z)>
+q.toFixed(z)&&(d=c>w?-(c-w):-(n-(k-q)))))):0<c&&(k="right"===p.hemisphere?r:n,d=c,null!==k&&(n=c,c=f[k].indexLabelTextBlock.y-f[k].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-n<w&&(q=n,k=h(k,q,g+1),+k.toFixed(z)<+q.toFixed(z)&&(d=c>w?c-w:n-(q-k)))));d&&(g=p.indexLabelTextBlock.y+d,c=0,c="right"===p.hemisphere?u.x+Math.sqrt(Math.pow(v,2)-Math.pow(g-u.y,2)):u.x-Math.sqrt(Math.pow(v,2)-Math.pow(g-u.y,2)),p.midAngle>Math.PI/2-s&&p.midAngle<Math.PI/2+s?(q=(a-
1+f.length)%f.length,q=f[q],a=f[(a+1+f.length)%f.length],"left"===p.hemisphere&&"right"===q.hemisphere&&c>q.indexLabelTextBlock.x?c=q.indexLabelTextBlock.x-15:"right"===p.hemisphere&&("left"===a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):p.midAngle>3*Math.PI/2-s&&p.midAngle<3*Math.PI/2+s&&(q=(a-1+f.length)%f.length,q=f[q],a=f[(a+1+f.length)%f.length],"right"===p.hemisphere&&"left"===q.hemisphere&&c<q.indexLabelTextBlock.x?c=q.indexLabelTextBlock.x+15:"left"===p.hemisphere&&
("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-15)),p.indexLabelTextBlock.y=g,p.indexLabelTextBlock.x=c,p.indexLabelAngle=Math.atan2(p.indexLabelTextBlock.y-u.y,p.indexLabelTextBlock.x-u.x))}return d}function q(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,g=0,d=!0,c=0;10>c&&(1>c||0<g);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&B-g<=A)d=!1;d&&(B-=
g);g=0;if("inside"!==k.indexLabelPlacement){v=B*x;for(a=0;a<l.length;a++){var q=f[a];q.indexLabelTextBlock.x=u.x+v*Math.cos(q.midAngle);q.indexLabelTextBlock.y=u.y+v*Math.sin(q.midAngle);q.indexLabelAngle=q.midAngle;q.radius=B;q.percentInnerRadius=H}for(var n,s,a=0;a<l.length;a++){var q=f[a],y=e(a);if(null!==y){n=f[a];s=f[y];var t=0,t=b(n,s)-w;if(0>t){for(var C=s=0,G=0;G<l.length;G++)G!==a&&f[G].hemisphere===q.hemisphere&&(f[G].indexLabelTextBlock.y<q.indexLabelTextBlock.y?s++:C++);s=t/(s+C||1)*C;
var C=-1*(t-s),K=G=0;"right"===q.hemisphere?(G=h(a,s),C=-1*(t-G),K=h(y,C),+K.toFixed(z)<+C.toFixed(z)&&+G.toFixed(z)<=+s.toFixed(z)&&h(a,-(C-K))):(G=h(y,s),C=-1*(t-G),K=h(a,C),+K.toFixed(z)<+C.toFixed(z)&&+G.toFixed(z)<=+s.toFixed(z)&&h(y,-(C-K)))}}}}else for(a=0;a<l.length;a++)q=f[a],v="pie"===k.type?0.7*B:0.85*B,y=u.x+v*Math.cos(q.midAngle),s=u.y+v*Math.sin(q.midAngle),q.indexLabelTextBlock.x=y,q.indexLabelTextBlock.y=s;for(a=0;a<l.length;a++)if(q=f[a],y=q.indexLabelTextBlock.measureText(),0!==
y.height&&0!==y.width)y=y=0,"right"===q.hemisphere?(y=r.x2-(q.indexLabelTextBlock.x+q.indexLabelTextBlock.width+p),y*=-1):y=r.x1-(q.indexLabelTextBlock.x-q.indexLabelTextBlock.width-p),0<y&&(!d&&q.indexLabelText&&(s="right"===q.hemisphere?r.x2-q.indexLabelTextBlock.x:q.indexLabelTextBlock.x-r.x1,0.3*q.indexLabelTextBlock.maxWidth>s?q.indexLabelText="":q.indexLabelTextBlock.maxWidth=0.85*s,0.3*q.indexLabelTextBlock.maxWidth<s&&(q.indexLabelTextBlock.x-="right"===q.hemisphere?2:-2)),Math.abs(q.indexLabelTextBlock.y-
q.indexLabelTextBlock.height/2-u.y)<B||Math.abs(q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/2-u.y)<B)&&(y/=Math.abs(Math.cos(q.indexLabelAngle)),9<y&&(y*=0.3),y>g&&(g=y)),y=y=0,0<q.indexLabelAngle&&q.indexLabelAngle<Math.PI?(y=r.y2-(q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/2+5),y*=-1):y=r.y1-(q.indexLabelTextBlock.y-q.indexLabelTextBlock.height/2-5),0<y&&(!d&&q.indexLabelText&&(s=0<q.indexLabelAngle&&q.indexLabelAngle<Math.PI?-1:1,0===h(a,y*s)&&h(a,2*s)),Math.abs(q.indexLabelTextBlock.x-
u.x)<B&&(y/=Math.abs(Math.sin(q.indexLabelAngle)),9<y&&(y*=0.3),y>g&&(g=y)));var M=function(a,b,c){for(var e=[],g=0;e.push(f[b]),b!==c;b=(b+1+l.length)%l.length);e.sort(function(a,b){return a.y-b.y});for(b=0;b<e.length;b++)if(c=e[b],g<0.7*a)g+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,g=0,h=!1,q=0;q<l.length;q++)if(h=!1,n=f[q],n.indexLabelText){var d=e(q);if(null!==d){var k=f[d];t=0;
t=b(n,k);var r;if(r=0>t){r=n.indexLabelTextBlock.x;var m=n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2,s=n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2,y=k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2,u=k.indexLabelTextBlock.x+k.indexLabelTextBlock.width,v=k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2;r=n.indexLabelTextBlock.x+n.indexLabelTextBlock.width<k.indexLabelTextBlock.x-p||r>u+p||m>v+p||s<y-p?!1:!0}r?(0>a&&(a=q),d!==a&&(c=d,g+=-t),0===q%Math.max(l.length/
...
R[A].x3-R[A].x4:R[A].x3-R[A].x6,20>v[A]&&(v[A]=A!==da?s.reversed?R[A].x3-R[A].x4:R[A].x2-R[A].x1:R[A].x2-R[A].x1,v[A]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:s.options.indexLabelMaxWidth?s.indexLabelMaxWidth:v[A];if(m>v[A]||0>m)m=v[A];t[A]="inside"===s.indexLabelPlacement?r?Math.max(R[A].height,h):1.5*h:!1;I=x.getPercentAndTotal(s,b);if(s.indexLabelFormatter||b.indexLabelFormatter)B={chart:x.options,dataSeries:s,dataPoint:b,total:I.total,percent:I.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):
b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,s,A):s.indexLabelFormatter?s.indexLabelFormatter(B):s.indexLabel?x.replaceKeywordsWithValue(s.indexLabel,b,s,A):b.label?b.label:"";0>=l&&(l=0);1E3>m&&1E3-m<u&&(m+=1E3-m);n(s.options.indexLabelMaxWidth)&&(s.indexLabelMaxWidth=n(s.indexLabelMaxWidth)?m:Math.max(m,s.indexLabelMaxWidth));P.roundRect||za(P);c=new ja(P,{fontSize:h,fontFamily:d,fontColor:g,fontStyle:q,fontWeight:k,horizontalAlign:c,textAlign:y,backgroundColor:e,maxWidth:m,maxHeight:!1===
t[A]?r?4.28571429*h:1.5*h:t[A],text:b,padding:ea,textBaseline:"middle"});c.measureText();c.height=c.height===2*c.padding?0:c.height;c.width=c.width===2*c.padding?0:c.width;F.push({textBlock:c,id:s.reversed?C:A,isDirty:!1,lineColor:a,lineThickness:l,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,e,g,f=[];g=!1;c=0;for(var h,q=Q-V-X/2,q=s.options.indexLabelMaxWidth?s.indexLabelMaxWidth>q?q:s.indexLabelMaxWidth:q,
d=F.length-1;0<=d;d--){h=z[F[d].id];c=F[d];e=c.textBlock;b=(a=r(d)<R.length?F[r(d)]:null)?a.textBlock:null;c=c.height;a&&e.y+c+ea>b.y&&(g=!0);c=h.indexLabelMaxWidth||q;if(c>q||0>c)c=q;f.push(c)}if(g)for(d=F.length-1;0<=d;d--)a=R[d],F[d].textBlock.maxWidth=f[f.length-(d+1)],F[d].textBlock.measureText(),F[d].textBlock.height=F[d].textBlock.height===2*F[d].textBlock.padding?0:F[d].textBlock.height,F[d].textBlock.width=F[d].textBlock.width===2*F[d].textBlock.padding?0:F[d].textBlock.width,F[d].textBlock.x=
Q-q,c=F[d].textBlock.height<F[d].textBlock.maxHeight?F[d].textBlock.height:F[d].textBlock.maxHeight,g=F[d].textBlock.width<F[d].textBlock.maxWidth?F[d].textBlock.width:F[d].textBlock.maxWidth,F[d].height=c,F[d].width=g,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,F[d].textBlock.y=c-F[d].height/2,s.reversed?(F[d].textBlock.y+F[d].height>T+B&&(F[d].textBlock.y=T+B-F[d].height),F[d].textBlock.y<ta-B&&(F[d].textBlock.y=ta-B)):(F[d].textBlock.y<T-B&&(F[d].textBlock.y=T-B),F[d].textBlock.y+F[d].height>
...
T+B-F[e].height),F[e].textBlock.y<ta-B&&(F[e].textBlock.y=ta-B)):(F[e].textBlock.y<T-B&&(F[e].textBlock.y=T-B),F[e].textBlock.y+F[e].height>ta+B&&(F[e].textBlock.y=ta+B-F[e].height)));else for(e=0;e<R.length;e++)0==F[e].textBlock.text.length?F[e].isDirty=!0:(a=R[e],b=a.height,c=F[e].height,g=F[e].width,b>=c?(b=e!=da?(a.x4+a.x3)/2-g/2:(a.x5+a.x4)/2-g/2,c=e!=da?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,F[e].textBlock.x=b,F[e].textBlock.y=c):F[e].isDirty=!0)}function q(){function a(b,c){var e;if(0>b||b>=F.length)return 0;
var g,f=F[b].textBlock;if(0>c){c*=-1;g=p(b);e=d(g,b);if(e>=c)return f.y-=c,c;if(0==b)return 0<e&&(f.y-=e),e;e+=a(g,-(c-e));0<e&&(f.y-=e);return e}g=r(b);e=d(b,g);if(e>=c)return f.y+=c,c;if(b==R.length-1)return 0<e&&(f.y+=e),e;e+=a(g,c-e);0<e&&(f.y+=e);return e}function b(){var a,e,g,f,h=0,q;f=(O-Z+2*B)/l;q=l;for(var d,k=1;k<q;k++){g=k*f;for(var n=F.length-1;0<=n;n--)!F[n].isDirty&&(F[n].textBlock.y<g&&F[n].textBlock.y+F[n].height>g)&&(d=r(n),!(d>=F.length-1)&&F[n].textBlock.y+F[n].height+ea>F[d].textBlock.y&&
(F[n].textBlock.y=F[n].textBlock.y+F[n].height-g>g-F[n].textBlock.y?g+1:g-F[n].height-1))}for(d=R.length-1;0<d;d--)if(!F[d].isDirty){g=p(d);if(0>g&&(g=0,F[g].isDirty))break;if(F[d].textBlock.y<F[g].textBlock.y+F[g].height){e=e||d;f=d;for(q=0;F[f].textBlock.y<F[g].textBlock.y+F[g].height+ea;){a=a||F[f].textBlock.y+F[f].height;q+=F[f].height;q+=ea;f=g;if(0>=f){f=0;q+=F[f].height;break}g=p(f);if(0>g){f=0;q+=F[f].height;break}}if(f!=d){h=F[f].textBlock.y;a-=h;a=q-a;h=c(a,e,f);break}}}return h}function c(a,
b,e){var g=[],f=0,h=0;for(a=Math.abs(a);e<=b;e++)g.push(R[e]);g.sort(function(a,b){return a.height-b.height});for(e=0;e<g.length;e++)if(b=g[e],f<a)h++,f+=F[b.id].height+ea,F[b.id].textBlock.text="",F[b.id].indexLabelText="",F[b.id].isDirty=!0,F[b.id].textBlock.measureText();else break;return h}for(var e,g,f,h,q,k,l=1,n=0;n<2*l;n++){for(var m=F.length-1;0<=m&&!(0<=p(m)&&p(m),f=F[m],h=f.textBlock,k=(q=r(m)<R.length?F[r(m)]:null)?q.textBlock:null,e=+f.height.toFixed(6),g=+h.y.toFixed(6),!f.isDirty&&
(q&&g+e+ea>+k.y.toFixed(6))&&(e=h.y+e+ea-k.y,g=a(m,-e),g<e&&(0<g&&(e-=g),g=a(r(m),e),g!=e)));m--);b()}}function d(a,b){return(b<R.length?F[b].textBlock.y:s.reversed?T+B:ta+B)-(0>a?s.reversed?ta-B:T-B:F[a].textBlock.y+F[a].height+ea)}function m(a,b,c){var e,g,f,q=[],d=B,p=[];-1!==b&&(0<=$.indexOf(b)?(g=$.indexOf(b),$.splice(g,1)):($.push(b),$=$.sort(function(a,b){return a-b})));if(0===$.length)q=ia;else{g=B*(1!=$.length||0!=$[0]&&$[0]!=R.length-1?2:1)/k();for(var r=0;r<R.length;r++){if(1==$.length&&
0==$[0]){if(0===r){q.push(ia[r]);e=d;continue}}else 0===r&&(e=-1*d);q.push(ia[r]+e);if(0<=$.indexOf(r)||r<R.length&&0<=$.indexOf(r+1))e+=g}}f=function(){for(var a=[],b=0;b<R.length;b++)a.push(q[b]-R[b].y1);return a}();var n={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,e){return K.easing.easeOutQuart(a,b,c,e)},changeSection:function(a){for(var b,c,e=0;e<R.length;e++)b=f[e],c=R[e],b*=a,"undefined"===typeof p[e]&&(p[e]=0),0>p&&(p*=-1),c.y1+=b-p[e],c.y2+=b-p[e],c.y3+=
...
for(E=0;E<z.length;E++)z[E].exploded&&(U=!0,s.reversed?$.push(z.length-1-E):$.push(E));P.clearRect(u.x1,u.y1,u.width,u.height);P.fillStyle=x.backgroundColor;P.fillRect(u.x1,u.y1,u.width,u.height);if(J&&s.visible&&(b(),h(),"inside"!==s.indexLabelPlacement)){e();q();for(E=0;E<z.length;E++)F[E].isDirty||(a=F[E].textBlock.x+F[E].width,a=(Q-a)/2,0==E&&(A=a),A>a&&(A=a));for(E=0;E<R.length;E++)R[E].x1+=A,R[E].x2+=A,R[E].x3+=A,R[E].x4+=A,R[E].x5&&(R[E].x5+=A,R[E].x6+=A),F[E].textBlock.x+=A}for(E=0;E<R.length;E++)A=
...
"#percent",d="#total",n=this.getPercentAndTotal(c,g),d=isNaN(n.total)?d:n.total,q=isNaN(n.percent)?q:n.percent;do{n="";if(c.percentFormatString)n=c.percentFormatString;else{var n="#,##0.",k=Math.max(Math.ceil(Math.log(1/Math.abs(q))/Math.LN10),2);if(isNaN(k)||!isFinite(k))k=2;for(var l=0;l<k;l++)n+="#";c.percentFormatString=n}a=a.replace("#percent",fa(q,n,h._cultureInfo));a=a.replace("#total",fa(d,c.yValueFormatString?c.yValueFormatString:"#,##0.########",h._cultureInfo))}while(0<=a.indexOf("#percent")||
0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Ga(a.slice(1,a.length-1));a=a.replace("#index",e);var q=null;try{var f=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);f&&0<f.length&&(q=Ga(f[2]),a=Ga(f[1]))}catch(d){}f=null;if("color"===a)return"waterfall"===c.type?g.color?g.color:0<g.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[q%c._colorSet.length]:
g.color?g.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(g.hasOwnProperty(a))f=g;else if(c.hasOwnProperty(a))f=c;else return"";f=f[a];null!==q&&(f=f[q]);return"x"===a?(c.axisX&&"dateTime"===c.axisX.valueType||"dateTime"===c.xValueType||g.x&&g.x.getTime)&&!c.axisX.logarithmic?Ca(f,g.xValueFormatString?g.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString=h.axisX&&h.axisX.autoValueFormatString?h.axisX.autoValueFormatString:"DD MMM YY",h._cultureInfo):fa(f,g.xValueFormatString?
...
this.chart,g=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,h=0,q=0,d=this.markerMargin=this.chart.options.legend&&!n(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var m=[],k=[];if("top"===this.verticalAlign||"bottom"===this.verticalAlign)this.orientation="horizontal",c=this.verticalAlign,h=this.maxWidth=null!==this.maxWidth?this.maxWidth:g.width,q=this.maxHeight=null!==this.maxHeight?this.maxHeight:0.5*g.height;else if("center"===this.verticalAlign){this.orientation=
"vertical";if("left"===this.horizontalAlign||"center"===this.horizontalAlign||"right"===this.horizontalAlign)c=this.horizontalAlign;h=this.maxWidth=null!==this.maxWidth?this.maxWidth:0.5*g.width;q=this.maxHeight=null!==this.maxHeight?this.maxHeight:g.height}this.errorMarkerColor=[];for(var l=0;l<this.dataSeries.length;l++){var p=this.dataSeries[l];if(p.dataPoints&&p.dataPoints.length){if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type&&"pyramid"!==p.type){var r=p.legendMarkerType=p.legendMarkerType?
...
p.dataPoints[0],p,l);r={markerType:r,markerColor:w,text:f,textBlock:null,chartType:p.type,markerSize:v,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:x,markerBorderThickness:s};m.push(r)}else for(var z=0;z<p.dataPoints.length;z++){var u=p.dataPoints[z],r=u.legendMarkerType?u.legendMarkerType:p.legendMarkerType?p.legendMarkerType:V.getDefaultLegendMarker(p.type),f=u.legendText?u.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,
...
p.legendMarkerBorderThickness:u.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,f=this.chart.replaceKeywordsWithValue(f,u,p,z),r={markerType:r,markerColor:w,text:f,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:l,dataPointIndex:z,markerBorderColor:x,markerBorderThickness:s};(u.showInLegend||p.showInLegend&&!1!==u.showInLegend)&&m.push(r)}n(p.legendText)&&(p.legendText=p.name)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;f=u=z=0;u=null!==this.itemWidth?
null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,h):this.itemMaxWidth=Math.min(this.itemWidth,h):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,h):this.itemMaxWidth=h;v=0===v?0.75*this.lineHeight:v;u=(this.itemMaxWidth?this.itemMaxWidth:u)-(v+d);for(l=0;l<m.length;l++){r=m[l];w=u;if("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType)w-=2*0.1*this.lineHeight;if(!(0>=q||"undefined"===typeof q||0>=w||"undefined"===typeof w))if("horizontal"===this.orientation){r.textBlock=
new ja(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?q:this.lineHeight,angle:0,text:r.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"});r.textBlock.measureText();null!==this.itemWidth&&(r.textBlock.width=this.itemWidth-(v+d+("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(r.textBlock.width+
v+d+(0===p.width?0:this.horizontalSpacing)+("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType?2*0.1*this.lineHeight:0))>h)p={items:[],width:0},k.push(p),this.height+=f,f=0;f=Math.max(f,r.textBlock.height?r.textBlock.height:this.lineHeight);r.textBlock.x=p.width;r.textBlock.y=0;p.width+=Math.round(r.textBlock.width+v+d+(0===p.width?0:this.horizontalSpacing)+("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType?2*0.1*this.lineHeight:0));p.items.push(r);this.width=
Math.max(p.width,this.width)}else r.textBlock=new ja(this.ctx,{x:0,y:0,maxWidth:u,maxHeight:!0===this.itemWrap?q:1.5*this.fontSize,angle:0,text:r.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),r.textBlock.measureText(),null!==this.itemWidth&&(r.textBlock.width=this.itemWidth-(v+d+("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType?2*0.1*this.lineHeight:
0))),this.height<q-this.lineHeight?(p={items:[],width:0},k.push(p)):(p=k[z],z=(z+1)%k.length),p&&(this.height+=r.textBlock.height?r.textBlock.height:this.lineHeight,r.textBlock.x=p.width,r.textBlock.y=0,p.width+=Math.round(r.textBlock.width+v+d+(0===p.width?0:this.horizontalSpacing)+("line"===r.chartType||"spline"===r.chartType||"stepLine"===r.chartType?2*0.1*this.lineHeight:0)),p.items.push(r),this.width=Math.max(p.width,this.width))}this.height=!1===this.itemWrap?k.length*this.lineHeight:this.height+
f;this.height=Math.min(q,this.height);this.width=Math.min(h,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?g.x1:"right"===this.horizontalAlign?g.x2-this.width:g.x1+g.width/2-this.width/2,b=g.y1):"center"===this.verticalAlign?(e="left"===this.horizontalAlign?g.x1:"right"===this.horizontalAlign?g.x2-this.width:g.x1+g.width/2-this.width/2,b=g.y1+g.height/2-this.height/2):"bottom"===this.verticalAlign&&(e="left"===this.horizontalAlign?g.x1:"right"===this.horizontalAlign?g.x2-
this.width:g.x1+g.width/2-this.width/2,b=g.y2-this.height);this.items=m;for(l=0;l<this.items.length;l++)r=m[l],r.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[r.id]={id:r.id,objectType:"legendItem",legendItemIndex:l,dataSeriesIndex:r.dataSeriesIndex,dataPointIndex:r.dataPointIndex};this.markerSize=v;this.rows=k;0<m.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+this.width,y2:b+this.height}};P.prototype.render=
function(){var a=this.bounds.x1,g=this.bounds.y1,c=this.markerMargin,b=this.maxWidth,e=this.maxHeight,h=this.markerSize,q=this.rows;(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(a,g,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var d=0,n=0;n<q.length;n++){for(var k=q[n],l=0,p=0;p<k.items.length;p++){var r=k.items[p],f=r.textBlock.x+a+(0===p?0.2*h:this.horizontalSpacing),m=g+d,v=f;this.chart.data[r.dataSeriesIndex].visible||
(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,g,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===r.chartType||"stepLine"===r.chartType||"spline"===r.chartType)this.ctx.strokeStyle=r.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(f-0.1*this.lineHeight,m+this.lineHeight/2),this.ctx.lineTo(f+0.85*this.lineHeight,m+this.lineHeight/2),this.ctx.stroke(),v-=0.1*this.lineHeight;if("error"===r.chartType){this.ctx.strokeStyle=
...
r.markerType,"error"===r.chartType||"line"===r.chartType||"spline"===r.chartType?r.markerSize/2:r.markerSize,r.markerColor,r.markerBorderColor,r.markerBorderThickness);r.textBlock.x=f+c+h;if("line"===r.chartType||"stepLine"===r.chartType||"spline"===r.chartType)r.textBlock.x+=0.1*this.lineHeight;r.textBlock.y=Math.round(m+this.lineHeight/2);r.textBlock.render(!0);this.ctx.restore();l=0<p?Math.max(l,r.textBlock.height?r.textBlock.height:this.lineHeight):r.textBlock.height?r.textBlock.height:this.lineHeight;
this.chart.data[r.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);f=X(r.id);this.ghostCtx.fillStyle=f;this.ghostCtx.beginPath();this.ghostCtx.fillRect(v,r.textBlock.y-this.lineHeight/2,r.textBlock.x+r.textBlock.width-v,r.textBlock.height?r.textBlock.height:this.lineHeight);r.x1=this.chart._eventManager.objectMap[r.id].x1=v;r.y1=this.chart._eventManager.objectMap[r.id].y1=r.textBlock.y-this.lineHeight/2;r.x2=this.chart._eventManager.objectMap[r.id].x2=r.textBlock.x+r.textBlock.width;r.y2=this.chart._eventManager.objectMap[r.id].y2=
r.textBlock.y+(r.textBlock.height?r.textBlock.height:this.lineHeight)-this.lineHeight/2}d+=l}};pa(V,T);V.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===
...
c};V.prototype.getDataPointAtXY=function(a,g,c){if(!this.dataPoints||0===this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||g<this.chart.plotArea.y1||g>this.chart.plotArea.y2)return null;c=c||!1;var b=[],e=0,h=0,d=1,m=!1,w=Infinity,k=0,l=0,p=0;if("none"!==this.chart.plotInfo.axisPlacement)if(p=(this.chart.axisX[0]?this.chart.axisX[0]:this.chart.axisX2[0]).getXValueAt({x:a,y:g}),this.axisX.logarithmic)var r=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),
p=1<r?Math.min(Math.max((this.dataPoints.length-1)/r*Math.log(p/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;else r=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,p=0<r?Math.min(Math.max((this.dataPoints.length-1)/r*(p-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0;for(;;){h=0<d?p+e:p-e;if(0<=h&&h<this.dataPoints.length){var r=this.chart._eventManager.objectMap[this.dataPointIds[h]],f=this.dataPoints[h],t=null;if(r){switch(this.type){case "column":case "stackedColumn":case "stackedColumn100":case "bar":case "stackedBar":case "stackedBar100":case "rangeColumn":case "rangeBar":case "waterfall":case "error":a>=
r.x1&&(a<=r.x2&&g>=r.y1&&g<=r.y2)&&(b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y1-g),Math.abs(r.y2-g))}),m=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var v=ma("markerSize",f,this)||4,x=c?20:v,t=Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2));t<=x&&b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:t});r=
Math.abs(r.x1-a);r<=w?w=r:0<d?k++:l++;t<=v/2&&(m=!0);break;case "rangeArea":case "rangeSplineArea":v=ma("markerSize",f,this)||4;x=c?20:v;t=Math.min(Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2)),Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y2-g,2)));t<=x&&b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:t});r=Math.abs(r.x1-a);r<=w?w=r:0<d?k++:l++;t<=v/2&&(m=!0);break;case "bubble":v=r.size;t=Math.sqrt(Math.pow(r.x1-a,2)+Math.pow(r.y1-g,2));t<=v/2&&(b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,
distance:t}),m=!0);break;case "pie":case "doughnut":v=r.center;x="doughnut"===this.type?r.percentInnerRadius*r.radius:0;t=Math.sqrt(Math.pow(v.x-a,2)+Math.pow(v.y-g,2));t<r.radius&&t>x&&(t=Math.atan2(g-v.y,a-v.x),0>t&&(t+=2*Math.PI),t=Number(((180*(t/Math.PI)%360+360)%360).toFixed(12)),v=Number(((180*(r.startAngle/Math.PI)%360+360)%360).toFixed(12)),x=Number(((180*(r.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===x&&1<r.endAngle&&(x=360),v>=x&&(0!==f.y&&!n(f.y))&&(x+=360,t<v&&(t+=360)),t>v&&t<x&&
(b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:0}),m=!0));break;case "funnel":case "pyramid":t=r.funnelSection;g>t.y1&&g<t.y4&&(t.y6?g>t.y6?(h=t.x6+(t.x5-t.x6)/(t.y5-t.y6)*(g-t.y6),t=t.x3+(t.x4-t.x3)/(t.y4-t.y3)*(g-t.y3)):(h=t.x1+(t.x6-t.x1)/(t.y6-t.y1)*(g-t.y1),t=t.x2+(t.x3-t.x2)/(t.y3-t.y2)*(g-t.y2)):(h=t.x1+(t.x4-t.x1)/(t.y4-t.y1)*(g-t.y1),t=t.x2+(t.x3-t.x2)/(t.y3-t.y2)*(g-t.y2)),a>h&&a<t&&(b.push({dataPoint:f,dataPointIndex:r.dataPointIndex,dataSeries:this,distance:0}),m=!0));
break;case "boxAndWhisker":if(a>=r.x1-r.borderThickness/2&&a<=r.x2+r.borderThickness/2&&g>=r.y4-r.borderThickness/2&&g<=r.y1+r.borderThickness/2||Math.abs(r.x2-a+r.x1-a)<r.borderThickness&&g>=r.y1&&g<=r.y4)b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y2-g),Math.abs(r.y3-g))}),m=!0;break;case "candlestick":if(a>=r.x1-r.borderThickness/2&&a<=r.x2+r.borderThickness/2&&g>=r.y2-r.borderThickness/2&&g<=r.y3+r.borderThickness/2||Math.abs(r.x2-
a+r.x1-a)<r.borderThickness&&g>=r.y1&&g<=r.y4)b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:Math.min(Math.abs(r.x1-a),Math.abs(r.x2-a),Math.abs(r.y2-g),Math.abs(r.y3-g))}),m=!0;break;case "ohlc":if(Math.abs(r.x2-a+r.x1-a)<r.borderThickness&&g>=r.y2&&g<=r.y3||a>=r.x1&&a<=(r.x2+r.x1)/2&&g>=r.y1-r.borderThickness/2&&g<=r.y1+r.borderThickness/2||a>=(r.x1+r.x2)/2&&a<=r.x2&&g>=r.y4-r.borderThickness/2&&g<=r.y4+r.borderThickness/2)b.push({dataPoint:f,dataPointIndex:h,dataSeries:this,distance:Math.min(Math.abs(r.x1-
a),Math.abs(r.x2-a),Math.abs(r.y2-g),Math.abs(r.y3-g))}),m=!0}if(m||1E3<k&&1E3<l)break}}else if(0>p-e&&p+e>=this.dataPoints.length)break;-1===d?(e++,d=1):d=-1}a=null;for(g=0;g<b.length;g++)a?b[g].distance<=a.distance&&(a=b[g]):a=b[g];return a};V.prototype.getMarkerProperties=function(a,g,c,b){var e=this.dataPoints,h=e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:e[a].color?e[a].color:this.color?this.color:this._colorSet[a%this._colorSet.length],d=e[a].markerBorderColor?e[a].markerBorderColor:
...
[],r=p.length?n(this.scaleBreaks.firstBreakIndex)?0:this.scaleBreaks.firstBreakIndex:0;if("axisX"!==this.type||"dateTime"!==this.valueType||this.logarithmic){e=this.viewportMaximum;if(this.labels){a=Math.ceil(b);for(var b=Math.ceil(this.intervalStartPosition),f=!1,c=b;c<this.viewportMaximum;c+=a)if(this.labels[c])f=!0;else{f=!1;break}f&&(this.interval=a,this.intervalStartPosition=b)}if(this.logarithmic&&!this.equidistantInterval)for(this.logLabelValues||(this.logLabelValues=[],this.createExtraLabelsForLog()),
...
this._labels.push({position:l,textBlock:a,effectiveHeight:null}))}}else for(this.intervalStartPosition=this.getLabelStartPoint(new Date(this.viewportMinimum),this.intervalType,this.interval),e=Ya(new Date(this.viewportMaximum),this.interval,this.intervalType),f=r,c=this.intervalStartPosition;c<e;Ya(c,b,this.intervalType)){for(a=c.getTime();f<p.length&&a>p[f].endValue;f++);l=a;a=f<p.length&&a>=p[f].startValue&&a<=p[f].endValue;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,
...
d,this.sessionVariables.labelWrap=this.labelWrap);else{if(n(this.options.labelWrap))if(!n(this.options.labelMaxWidth))this.options.labelMaxWidth<h?(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=d);else if(!n(g))if(b=A.width+g.width>>0,f=this.labelFontSize,r<h)b-2*h>p&&(p=b-2*h,b>=2*h&&b<2.2*h?(this.sessionVariables.labelMaxWidth=
h,n(this.options.labelFontSize)&&12<f&&(f=Math.floor(12/13*f),a.measureText()),this.sessionVariables.labelFontSize=n(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):b>=2.2*h&&b<2.8*h?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=l,this.sessionVariables.labelFontSize=f):b>=2.8*h&&b<3.2*h?(this.sessionVariables.labelMaxWidth=Math.max(h,r),this.sessionVariables.labelWrap=!0,n(this.options.labelFontSize)&&12<this.labelFontSize&&
...
"inside"===this.labelPlacement&&(a+=0<this._index?h:0),a<h&&(a=h),this.stripLineLabelEffectiveHeight=this._stripLineLabels[c].effectiveHeight=h)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?0<this._index?this.tickLength:0:this.tickLength)+b};A.setLayout=function(a,g,c,b,e,h){var d,m,t,k,l=a[0]?a[0].chart:g[0].chart,p=l.isNavigator?0:10,r=l._axes;if(a&&0<a.length)for(var f=0;f<a.length;f++)a[f]&&a[f].calculateAxisParameters();if(g&&0<g.length)for(f=
0;f<g.length;f++)g[f].calculateAxisParameters();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateAxisParameters();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateAxisParameters();for(f=0;f<r.length;f++)if(r[f]&&r[f].scaleBreaks&&r[f].scaleBreaks._appliedBreaks.length)for(var w=r[f].scaleBreaks._appliedBreaks,v=0;v<w.length&&!(w[v].startValue>r[f].viewportMaximum);v++)w[v].endValue<r[f].viewportMinimum||(n(r[f].scaleBreaks.firstBreakIndex)&&(r[f].scaleBreaks.firstBreakIndex=v),w[v].startValue>=
r[f].viewPortMinimum&&(r[f].scaleBreaks.lastBreakIndex=v));for(var x=v=0,s=0,z=0,u=0,A=0,B=0,D,G,H=m=0,J,K,L,w=J=K=L=!1,f=0;f<r.length;f++)r[f]&&r[f].title&&(r[f]._titleTextBlock=new ja(r[f].ctx,{text:r[f].title,horizontalAlign:"center",fontSize:r[f].titleFontSize,fontFamily:r[f].titleFontFamily,fontWeight:r[f].titleFontWeight,fontColor:r[f].titleFontColor,fontStyle:r[f].titleFontStyle,borderColor:r[f].titleBorderColor,borderThickness:r[f].titleBorderThickness,backgroundColor:r[f].titleBackgroundColor,
cornerRadius:r[f].titleCornerRadius,textBaseline:"middle"}));for(f=0;f<r.length;f++)if(r[f].title)switch(r[f]._position){case "left":r[f]._titleTextBlock.maxWidth=r[f].titleMaxWidth||h.height;r[f]._titleTextBlock.maxHeight=r[f].titleWrap?0.8*h.width:1.5*r[f].titleFontSize;r[f]._titleTextBlock.angle=-90;break;case "right":r[f]._titleTextBlock.maxWidth=r[f].titleMaxWidth||h.height;r[f]._titleTextBlock.maxHeight=r[f].titleWrap?0.8*h.width:1.5*r[f].titleFontSize;r[f]._titleTextBlock.angle=90;break;default:r[f]._titleTextBlock.maxWidth=
r[f].titleMaxWidth||h.width,r[f]._titleTextBlock.maxHeight=r[f].titleWrap?0.8*h.height:1.5*r[f].titleFontSize,r[f]._titleTextBlock.angle=0}if("normal"===e){for(var z=[],u=[],A=[],B=[],N=[],Q=[],O=[],P=[];4>v;){var E=0,X=0,T=0,S=0,V=e=0,M=0,$=0,W=0,Y=0,R=0,aa=0;if(c&&0<c.length)for(A=[],f=R=0;f<c.length;f++)A.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateWidth():0)),R+=A[f],M+=c[f]&&!l.isNavigator?c[f].margin:0;else A.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));O.push(A);if(b&&
0<b.length)for(B=[],f=aa=0;f<b.length;f++)B.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateWidth():0)),aa+=B[f],$+=b[f]?b[f].margin:0;else B.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));P.push(B);d=Math.round(h.x1+R+M);t=Math.round(h.x2-aa-$>l.width-p?l.width-p:h.x2-aa-$);if(a&&0<a.length)for(z=[],f=W=0;f<a.length;f++)a[f]&&(a[f].lineCoordinates={}),a[f].lineCoordinates.width=Math.abs(t-d),a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.width?
a[f].titleMaxWidth:a[f].lineCoordinates.width),z.push(Math.ceil(a[f]?a[f].createLabelsAndCalculateHeight():0)),W+=z[f],e+=a[f]&&!l.isNavigator?a[f].margin:0;else z.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));N.push(z);if(g&&0<g.length)for(u=[],f=Y=0;f<g.length;f++)g[f]&&(g[f].lineCoordinates={}),g[f].lineCoordinates.width=Math.abs(t-d),g[f].title&&(g[f]._titleTextBlock.maxWidth=0<g[f].titleMaxWidth&&g[f].titleMaxWidth<g[f].lineCoordinates.width?g[f].titleMaxWidth:g[f].lineCoordinates.width),
u.push(Math.ceil(g[f]?g[f].createLabelsAndCalculateHeight():0)),Y+=u[f],V+=g[f]&&!l.isNavigator?g[f].margin:0;else u.push(Math.ceil(g[0]?g[0].createLabelsAndCalculateHeight():0));Q.push(u);if(a&&0<a.length)for(f=0;f<a.length;f++)a[f]&&(a[f].lineCoordinates.x1=d,t=Math.round(h.x2-aa-$>l.width-p?l.width-p:h.x2-aa-$),a[f]._labels&&1<a[f]._labels.length&&(m=k=0,k=a[f]._labels[1],m="dateTime"===a[f].valueType?a[f]._labels[a[f]._labels.length-2]:a[f]._labels[a[f]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/
180*Math.abs(k.textBlock.angle))+(k.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),s=m.textBlock.width*Math.cos(Math.PI/180*Math.abs(m.textBlock.angle))+(m.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(m.textBlock.angle))),!a[f]||(!a[f].labelAutoFit||n(D)||n(G)||l.isNavigator||l.stockChart)||(m=0,0<a[f].labelAngle?G+s>t&&(m+=0<a[f].labelAngle?G+s-t-aa:0):0>a[f].labelAngle?D-x<d&&D-x<a[f].viewportMinimum&&(H=d-(M+a[f].tickLength+
A+D-x+a[f].labelFontSize/2)):0===a[f].labelAngle&&(G+s>t&&(m=G+s/2-t-aa),D-x<d&&D-x<a[f].viewportMinimum&&(H=d-M-a[f].tickLength-A-D+x/2)),a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0<a[f].labelAngle&&0<m?t-=m:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0>a[f].labelAngle&&0<H?d+=H:a[f].viewportMaximum===a[f].maximum&&a[f].viewportMinimum===a[f].minimum&&0===a[f].labelAngle&&(0<H&&(d+=H),0<m&&(t-=m))),l.panEnabled?W=n(l.sessionVariables.axisX.height)||
l.stockChart?l.sessionVariables.axisX.height=W:l.sessionVariables.axisX.height:l.sessionVariables.axisX.height=W,m=Math.round(h.y2-W-e+E),k=Math.round(h.y2),a[f].lineCoordinates.x2=t,a[f].lineCoordinates.width=t-d,a[f].lineCoordinates.y1=m,a[f].lineCoordinates.y2=m,"inside"===a[f].labelPlacement&&0<f&&(a[f].lineCoordinates.y1=a[f-1].lineCoordinates.y2+E+(a[f].labelEffectiveHeight||0),a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2),"inside"===a[f].tickPlacement&&0<f&&(a[f].lineCoordinates.y1+=
a[f].tickLength,a[f].lineCoordinates.y2=a[f].lineCoordinates.y1+a[f].lineThickness/2),a[f].bounds={x1:d,y1:m,x2:t,y2:k-(W+e-z[f]-E),width:t-d},a[f].bounds.height=a[f].bounds.y2-a[f].bounds.y1),E+=z[f]+a[f].margin;if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].lineCoordinates.x1=Math.round(h.x1+R+M),g[f].lineCoordinates.x2=Math.round(h.x2-aa-$>l.width-p?l.width-p:h.x2-aa-$),g[f].lineCoordinates.width=Math.abs(t-d),g[f]._labels&&1<g[f]._labels.length&&(k=g[f]._labels[1],m="dateTime"===g[f].valueType?
g[f]._labels[g[f]._labels.length-2]:g[f]._labels[g[f]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),s=m.textBlock.width*Math.cos(Math.PI/180*Math.abs(m.textBlock.angle))+(m.textBlock.height-m.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(m.textBlock.angle))),l.panEnabled?Y=n(l.sessionVariables.axisX2.height)||l.stockChart?l.sessionVariables.axisX2.height=Y:
l.sessionVariables.axisX2.height:l.sessionVariables.axisX2.height=Y,m=Math.round(h.y1),k=g[f].lineCoordinates.y1=m+Y+V-X,g[f].lineCoordinates.y2=m,"inside"===g[f].labelPlacement&&0<f&&(g[f].lineCoordinates.y1=g[f-1].lineCoordinates.y1-X-(g[f].labelEffectiveHeight||0)),"inside"===g[f].tickPlacement&&0<f&&(g[f].lineCoordinates.y1-=g[f].tickLength),g[f].bounds={x1:d,y1:m+(Y+V-u[f]-X),x2:t,y2:k,width:t-d},g[f].bounds.height=g[f].bounds.y2-g[f].bounds.y1,X+=u[f]+g[f].margin;if(c&&0<c.length)for(f=0;f<
c.length;f++)M=l.isNavigator?0:10,c[f]&&(d=Math.round(a[0]?a[0].lineCoordinates.x1:g[0].lineCoordinates.x1),M=c[f]._labels&&0<c[f]._labels.length?c[f]._labels[c[f]._labels.length-1].textBlock.height/2:p,m=Math.round(h.y1+Y+V<Math.max(M,p)?Math.max(M,p):h.y1+Y+V),t=Math.round(a[0]?a[0].lineCoordinates.x1:g[0].lineCoordinates.x1),M=0<a.length?0:c[f]._labels&&0<c[f]._labels.length?c[f]._labels[0].textBlock.height/2:p,k=Math.round(h.y2-W-e-M),c[f].lineCoordinates={x1:d-T,y1:m,x2:t-T,y2:k,height:Math.abs(k-
m)},"inside"===c[f].labelPlacement&&0<f&&(c[f].lineCoordinates.x1=c[f-1].lineCoordinates.x1-T-(c[f].labelEffectiveWidth||0),c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&0<f&&(c[f].lineCoordinates.x1-=c[f].tickLength,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),c[f].bounds={x1:d-(A[f]+T),y1:m,x2:t-T,y2:k,height:k-m},c[f].bounds.width=c[f].bounds.x2-c[f].bounds.x1,c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&
c[f].titleMaxWidth<c[f].lineCoordinates.height?c[f].titleMaxWidth:c[f].lineCoordinates.height),T+=A[f]+c[f].margin);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&(d=Math.round(a[0]?a[0].lineCoordinates.x2:g[0].lineCoordinates.x2),t=Math.round(d),M=b[f]._labels&&0<b[f]._labels.length?b[f]._labels[b[f]._labels.length-1].textBlock.height/2:0,m=Math.round(h.y1+Y+V<Math.max(M,p)?Math.max(M,p):h.y1+Y+V),M=0<a.length?0:b[f]._labels&&0<b[f]._labels.length?b[f]._labels[0].textBlock.height/2:0,k=Math.round(h.y2-
(W+e+M)),b[f].lineCoordinates={x1:d+S,y1:m,x2:d+S,y2:k,height:Math.abs(k-m)},"inside"===b[f].labelPlacement&&0<f&&(b[f].lineCoordinates.x1=b[f-1].lineCoordinates.x2+S+(b[f].labelEffectiveWidth||0),b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),"inside"===b[f].tickPlacement&&0<f&&(b[f].lineCoordinates.x1+=b[f].tickLength,b[f].lineCoordinates.x2=b[f].lineCoordinates.x1+b[f].lineThickness/2),b[f].bounds={x1:d+S,y1:m,x2:t+(B[f]+S),y2:k,height:k-m},b[f].bounds.width=b[f].bounds.x2-
b[f].bounds.x1,b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.height?b[f].titleMaxWidth:b[f].lineCoordinates.height),S+=B[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++)a[f]&&(a[f].calculateValueToPixelConversionParameters(),a[f].calculateBreaksSizeInValues(),a[f]._labels&&1<a[f]._labels.length&&(D=(a[f].logarithmic?Math.log(a[f]._labels[1].position/a[f].viewportMinimum)/a[f].conversionParameters.lnLogarithmBase:a[f]._labels[1].position-
...
0<c[f].titleMaxWidth&&c[f].titleMaxWidth<c[f].lineCoordinates.width?c[f].titleMaxWidth:c[f].lineCoordinates.width);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].lineCoordinates={},d=Math.round(h.x1+S+e),t=Math.round(h.x2-W-V>b[f].chart.width-10?b[f].chart.width-10:h.x2-W-V),b[f]&&b[f].labelAutoFit&&!n(A)&&(0<!a.length&&(d=0<b[f].labelAngle?Math.max(d,A):0===b[f].labelAngle?Math.max(d,A/2):d),0<!g.length&&(t-=B/2)),b[f].lineCoordinates.x1=d,b[f].lineCoordinates.x2=t,b[f].lineCoordinates.width=Math.abs(t-
...
b[f].lineCoordinates.y2=b[f].lineCoordinates.y1-b[f].lineThickness/2),b[f].bounds={x1:d,y1:m+(b[f].margin+E),x2:t,y2:k,width:t-d},b[f].bounds.height=b[f].bounds.y2-b[f].bounds.y1,b[f].title&&(b[f]._titleTextBlock.maxWidth=0<b[f].titleMaxWidth&&b[f].titleMaxWidth<b[f].lineCoordinates.width?b[f].titleMaxWidth:b[f].lineCoordinates.width),E+=D[f]+b[f].margin);if(a&&0<a.length)for(f=0;f<a.length;f++){M=a[f]._labels&&0<a[f]._labels.length?a[f]._labels[0].textBlock.fontSize/2:0;d=Math.round(h.x1+e);m=b&&
0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:h.y1<Math.max(M,10)?Math.max(M,10):h.y1):h.y1<Math.max(M,10)?Math.max(M,10):h.y1;t=Math.round(h.x1+S+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:h.y2-T>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2-T):h.y2>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(t=c[M].lineCoordinates.x1,d=0>c[M].labelAngle||0===c[M].labelAngle?t-S:d);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&
b[M].labelAutoFit&&(t=b[M].lineCoordinates.x1,d=t-S);a[f].lineCoordinates={x1:t-O,y1:m,x2:t-O,y2:k,height:Math.abs(k-m)};"inside"===a[f].labelPlacement&&0<f&&(a[f].lineCoordinates.x1=a[f].lineCoordinates.x1-(H[f]-(a[f]._titleTextBlock?a[f]._titleTextBlock.height:0))+a[f].tickLength+(a[f].stripLineLabelEffectiveWidth||0),a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+a[f].lineThickness/2);"inside"===a[f].tickPlacement&&0<f&&(a[f].lineCoordinates.x1-=a[f].tickLength,a[f].lineCoordinates.x2=a[f].lineCoordinates.x1+
a[f].lineThickness/2);a[f].bounds={x1:t-(H[f]+O),y1:m,x2:t-O,y2:k,height:k-m};a[f].bounds.width=a[f].bounds.x2-a[f].bounds.x1;a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.height?a[f].titleMaxWidth:a[f].lineCoordinates.height);a[f].calculateValueToPixelConversionParameters();a[f].calculateBreaksSizeInValues();O+=H[f]+a[f].margin}if(g&&0<g.length)for(f=0;f<g.length;f++){M=g[f]._labels&&0<g[f]._labels.length?g[f]._labels[0].textBlock.fontSize/
2:0;d=Math.round(h.x1-e);m=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:h.y1<Math.max(M,10)?Math.max(M,10):h.y1):h.y1<Math.max(M,10)?Math.max(M,10):h.y1;t=Math.round(h.x2-W-V);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:h.y2-T>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2-T):h.y2>l.height-Math.max(M,10)?l.height-Math.max(M,10):h.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(t=0>c[M].labelAngle?Math.max(t,z):0===c[M].labelAngle?Math.max(t,z/2):t,d=
0>c[M].labelAngle||0===c[M].labelAngle?t-W:d);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(t=b[M].lineCoordinates.x2,d=t-W);g[f].lineCoordinates={x1:t+P,y1:m,x2:t+P,y2:k,height:Math.abs(k-m)};"inside"===g[f].labelPlacement&&0<f&&(g[f].lineCoordinates.x1=g[f].lineCoordinates.x1+(x[f]-(g[f]._titleTextBlock?g[f]._titleTextBlock.height:0)-2)-g[f].tickLength-(g[f].stripLineLabelEffectiveWidth||0),g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);"inside"===g[f].tickPlacement&&
0<f&&(g[f].lineCoordinates.x1+=g[f].tickLength,g[f].lineCoordinates.x2=g[f].lineCoordinates.x1+g[f].lineThickness/2);g[f].bounds={x1:g[f].lineCoordinates.x1,y1:m,x2:t+x[f]+P,y2:k,width:t-d,height:k-m};g[f].bounds.width=g[f].bounds.x2-g[f].bounds.x1;g[f].title&&(g[f]._titleTextBlock.maxWidth=0<g[f].titleMaxWidth&&g[f].titleMaxWidth<g[f].lineCoordinates.height?g[f].titleMaxWidth:g[f].lineCoordinates.height);g[f].calculateValueToPixelConversionParameters();g[f].calculateBreaksSizeInValues();P+=x[f]+
g[f].margin}for(f=0;f<r.length;f++)"axisY"===r[f].type&&(r[f].calculateValueToPixelConversionParameters(),r[f].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(f=0;f<a.length;f++)w=N[v-1][f]===N[v][f]?!0:!1;else w=!0;if(g&&0<g.length)for(f=0;f<g.length;f++)J=Q[v-1][f]===Q[v][f]?!0:!1;else J=!0;if(c&&0<c.length)for(f=0;f<c.length;f++)K=G[v-1][f]===G[v][f]?!0:!1;else K=!0;if(b&&0<b.length)for(f=0;f<b.length;f++)L=s[v-1][f]===s[v][f]?!0:!1;else L=!0}if(w&&J&&K&&L)break;v++}if(c&&0<c.length)for(f=
...
if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderInterlacedColors();if(g&&0<g.length)for(d=0;d<g.length;d++)g[d].renderInterlacedColors();if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].renderInterlacedColors();if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].renderInterlacedColors();e.restore();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].renderGrid(),w&&(a[d].createMask(),a[d].renderBreaksBackground());if(g&&0<g.length)for(d=0;d<g.length;d++)g[d].renderGrid(),w&&(g[d].createMask(),g[d].renderBreaksBackground());
...
this.tickThickness,this.ctx.strokeStyle=this.tickColor,b=1===this.ctx.lineWidth%2?(r.x<<0)+0.5:r.x<<0,this.ctx.beginPath(),this.ctx.moveTo(b,r.y<<0),this.ctx.lineTo(b,r.y+this.tickLength<<0),this.ctx.stroke()),g&&0!==h++%2&&this.labelAutoFit||(0===p.textBlock.angle?(r.x-=p.textBlock.width/2,r.y="inside"===this.labelPlacement?r.y-(("inside"===this.tickPlacement?this.tickLength:0)+p.textBlock.height-p.textBlock.fontSize/2):r.y+("inside"===this.tickPlacement?0:this.tickLength)+p.textBlock.fontSize/2+
5):(r.x="inside"===this.labelPlacement?0>this.labelAngle?r.x:r.x-p.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):r.x-(0>this.labelAngle?p.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0),r.y="inside"===this.labelPlacement?0>this.labelAngle?r.y-("inside"===this.tickPlacement?this.tickLength:0)-5:r.y-("inside"===this.tickPlacement?this.tickLength:0)-Math.abs(p.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)+5):r.y+("inside"===this.tickPlacement?0:this.tickLength)+Math.abs(0>this.labelAngle?
p.textBlock.width*Math.sin(Math.PI/180*this.labelAngle)-5:5)),p.textBlock.x=r.x,p.textBlock.y=r.y));"inside"===this.tickPlacement&&this.chart.addEventListener("dataAnimationIterationEnd",function(){for(k=0;k<a._labels.length;k++)if(p=a._labels[k],!(p.position<a.viewportMinimum||p.position>a.viewportMaximum)&&(r=a.getPixelCoordinatesOnAxis(p.position),a.tickThickness)){a.ctx.lineWidth=a.tickThickness;a.ctx.strokeStyle=a.tickColor;var b=1===a.ctx.lineWidth%2?(r.x<<0)+0.5:r.x<<0;a.ctx.save();a.ctx.beginPath();
a.ctx.moveTo(b,r.y<<0);a.ctx.lineTo(b,r.y-a.tickLength<<0);a.ctx.stroke();a.ctx.restore()}},this);this.title&&(this._titleTextBlock.measureText(),this._titleTextBlock.x=this.lineCoordinates.x1+this.lineCoordinates.width/2-this._titleTextBlock.width/2,this._titleTextBlock.y=this.bounds.y2-this._titleTextBlock.height+this._titleTextBlock.fontSize/2-1,this.titleMaxWidth=this._titleTextBlock.maxWidth,this._titleTextBlock.render(!0))}else if("top"===this._position){for(k=0;k<this._labels.length;k++)p=
...
t=[],k=!1,e=0;e<this.stripLines.length;e++){var l=this.stripLines[e];l._thicknessType===a&&("pixel"===a&&(l.value<this.viewportMinimum||l.value>this.viewportMaximum||n(l.value)||isNaN(this.range))||"value"===a&&(l.startValue<=this.viewportMinimum&&l.endValue<=this.viewportMinimum||l.startValue>=this.viewportMaximum&&l.endValue>=this.viewportMaximum||n(l.startValue)||n(l.endValue)||isNaN(this.range))||m.push(l))}for(e=0;e<this._stripLineLabels.length;e++)if(l=this.stripLines[e],c=this._stripLineLabels[e],
...
c.textBlock.fontSize/2):(b.x+=(c.textBlock.height-this.tickLength-this.labelFontSize/2)*Math.sin(Math.PI/180*this.labelAngle)-(0<this.labelAngle?c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0),b.y-=this.tickLength+(c.textBlock.height*Math.cos(Math.PI/180*this.labelAngle)+(0<this.labelAngle?c.textBlock.width*Math.sin(Math.PI/180*this.labelAngle):0)))):"left"===this._position?(p=1===this.ctx.lineWidth%2?(b.y<<0)+0.5:b.y<<0,this.ctx.beginPath(),this.ctx.moveTo(b.x<<0,p),this.ctx.lineTo(b.x-
this.tickLength<<0,p),this.ctx.stroke(),0===this.labelAngle?b.x=b.x-c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)-this.tickLength-5:(b.y-=c.textBlock.width*Math.sin(Math.PI/180*this.labelAngle),b.x=0<this.labelAngle?b.x-c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)-this.tickLength-5:b.x-c.textBlock.width*Math.cos(Math.PI/180*this.labelAngle)+(c.textBlock.height-c.textBlock.fontSize/2-5)*Math.sin(Math.PI/180*this.labelAngle)-this.tickLength)):"right"===this._position&&(p=1===this.ctx.lineWidth%
2?(b.y<<0)+0.5:b.y<<0,this.ctx.beginPath(),this.ctx.moveTo(b.x<<0,p),this.ctx.lineTo(b.x+this.tickLength<<0,p),this.ctx.stroke(),0===this.labelAngle?b.x=b.x+this.tickLength+5:(b.y=0>this.labelAngle?b.y:b.y-(c.textBlock.height-c.textBlock.fontSize/2-5)*Math.cos(Math.PI/180*this.labelAngle),b.x=0<this.labelAngle?b.x+(c.textBlock.height-c.textBlock.fontSize/2-5)*Math.sin(Math.PI/180*this.labelAngle)+this.tickLength:b.x+this.tickLength+5));c.textBlock.x=b.x;c.textBlock.y=b.y;t.push(c)}else l._thicknessType===
a&&(c.textBlock.angle=-90,"bottom"===this._position?(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),b.x-c.textBlock.height-l.thickness/2>this.chart.plotArea.x1?n(l.startValue)?b.x-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,n(l.startValue)?b.x+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x+=
...
(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),b.x-c.textBlock.height-l.thickness/2>this.chart.plotArea.x1?n(l.startValue)?b.x-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,n(l.startValue)?b.x+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.x+=c.textBlock.height/2-c.textBlock.fontSize/2),b.y=-90===
...
(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x2-c.textBlock.width-3):"right"===this._position&&(c.textBlock.maxWidth=this.options.stripLines[e].labelMaxWidth?this.options.stripLines[e].labelMaxWidth:this.chart.plotArea.width-3,c.textBlock.angle=0,c.textBlock.measureText(),b.y-c.textBlock.height-l.thickness/2>this.chart.plotArea.y1?n(l.startValue)?b.y-=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/
2:n(l.startValue)?b.y+=c.textBlock.height-c.textBlock.fontSize/2+l.thickness/2:b.y-=c.textBlock.height/2-c.textBlock.fontSize/2+3,b.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x1+3),c.textBlock.x=b.x,c.textBlock.y=b.y,t.push(c));if(!k){b=!1;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,
...
this.lineColor?this.lineColor:"black";g.setLineDash&&g.setLineDash(G(this.lineDashType,this.lineThickness));var d=1===this.lineThickness%2?(this.lineCoordinates.y1<<0)+0.5:this.lineCoordinates.y1<<0;g.beginPath();if(this.scaleBreaks&&!n(this.scaleBreaks.firstBreakIndex))if(n(this.scaleBreaks.lastBreakIndex))e=this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel+b;else for(var m=this.scaleBreaks.firstBreakIndex;m<=this.scaleBreaks.lastBreakIndex;m++)g.moveTo(e,d),g.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel+
c,d),e=this.scaleBreaks._appliedBreaks[m].endPixel+b;e&&(g.moveTo(e,d),g.lineTo(h,d));g.stroke()}}else if(("left"===this._position||"right"===this._position)&&this.lineThickness){this.reversed?(e=this.lineCoordinates.y1,h=this.lineCoordinates.y2):(e=this.lineCoordinates.y2,h=this.lineCoordinates.y1);g.lineWidth=this.lineThickness;g.strokeStyle=this.lineColor;g.setLineDash&&g.setLineDash(G(this.lineDashType,this.lineThickness));d=1===this.lineThickness%2?(this.lineCoordinates.x1<<0)+0.5:this.lineCoordinates.x1<<
0;g.beginPath();if(this.scaleBreaks&&!n(this.scaleBreaks.firstBreakIndex))if(n(this.scaleBreaks.lastBreakIndex))e=this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel+c;else for(m=this.scaleBreaks.firstBreakIndex;m<=this.scaleBreaks.lastBreakIndex;m++)g.moveTo(d,e),g.lineTo(d,this.scaleBreaks._appliedBreaks[m].startPixel+b),e=this.scaleBreaks._appliedBreaks[m].endPixel+c;e&&(g.moveTo(d,e),g.lineTo(d,h));g.stroke()}w&&(a.drawImage(this.chart._preRenderCanvas,0,0,this.chart.width,
this.chart.height),this.chart._breaksCanvasCtx&&this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas,0,0,this.chart.width,this.chart.height),g.clearRect(0,0,this.chart.width,this.chart.height));g.restore()};A.prototype.getPixelCoordinatesOnAxis=function(a){var g={};if("bottom"===this._position||"top"===this._position)g.x=this.convertValueToPixel(a),g.y=this.lineCoordinates.y1;if("left"===this._position||"right"===this._position)g.y=this.convertValueToPixel(a),g.x=this.lineCoordinates.x2;
return g};A.prototype.convertPixelToValue=function(a){if("undefined"===typeof a)return null;var g=0,c=0,b,g=!0,e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[],c="number"===typeof a?a:"left"===this._position||"right"===this._position?a.y:a.x;if(this.logarithmic){a=b=Math.pow(this.logarithmBase,(c-this.conversionParameters.reference)/this.conversionParameters.pixelPerUnit);if(c<=this.conversionParameters.reference===("left"===this._position||"right"===this._position)!==this.reversed)for(c=0;c<
...
g=!1}else break;else if(b<e[c].endValue-e[c+1].startValue){b-=e[c].endValue-e[c+1].startValue;if(b>-1*e[c].size){a+=(e[c].endValue-e[c].startValue)*(0===e[c].size?1:b/e[c].size)+b;break}else a-=e[c].endValue-e[c].startValue-e[c].size;b+=e[c].size}else break;g=this.conversionParameters.minimum+a}return g};A.prototype.convertValueToPixel=function(a){a=this.getApparentDifference(this.conversionParameters.minimum,a,a);return this.logarithmic?this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*
Math.log(a/this.conversionParameters.minimum)/this.conversionParameters.lnLogarithmBase+0.5<<0:"axisX"===this.type?this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5};A.prototype.getApparentDifference=function(a,g,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=n(c)?g/a:c;for(var h=
...
a)/Math.log(e[h].endValue/e[h].startValue))))}else for(c=n(c)?Math.abs(g-a):c,h=0;h<e.length&&!(g<e[h].startValue);h++)a>e[h].endValue||(a<=e[h].startValue&&g>=e[h].endValue?c=c-e[h].endValue+e[h].startValue+e[h].size:a>e[h].startValue&&g>=e[h].endValue?c=c-e[h].endValue+a+e[h].size*(e[h].endValue-a)/(e[h].endValue-e[h].startValue):a<=e[h].startValue&&g<e[h].endValue?c=c-g+e[h].startValue+e[h].size*(g-e[h].startValue)/(e[h].endValue-e[h].startValue):!b&&(a>e[h].startValue&&g<e[h].endValue)&&(c=a+
e[h].size*(g-a)/(e[h].endValue-e[h].startValue)));return c};A.prototype.setViewPortRange=function(a,g){this.sessionVariables.newViewportMinimum=this.viewportMinimum=Math.min(a,g);this.sessionVariables.newViewportMaximum=this.viewportMaximum=Math.max(a,g)};A.prototype.getXValueAt=function(a){if(!a)return null;var g=null;"left"===this._position?g=this.convertPixelToValue(a.y):"bottom"===this._position&&(g=this.convertPixelToValue(a.x));return g};A.prototype.calculateValueToPixelConversionParameters=
...
(g.lnLogarithmBase=Math.log(this.logarithmBase),g.pixelPerUnit=(this.reversed?1:-1)*c*g.lnLogarithmBase/Math.log(Math.abs(b))):g.pixelPerUnit=(this.reversed?1:-1)*c/Math.abs(b),g.reference=this.reversed?this.lineCoordinates.y1:this.lineCoordinates.y2;this.conversionParameters=g};A.prototype.calculateAxisParameters=function(){if(this.logarithmic)this.calculateLogarithmicAxisParameters();else{var a=this.chart.layoutManager.getFreeSpace(),g=!1,c=!1;"bottom"===this._position||"top"===this._position?(this.maxWidth=
a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?"xySwapped"===this.chart.plotInfo.axisPlacement?62:70:"xySwapped"===this.chart.plotInfo.axisPlacement?50:40,b=4;"axisX"===this.type&&(b=600>this.maxWidth?8:6);var a=Math.max(b,Math.floor(this.maxWidth/a)),e,h,d,b=0;!n(this.options.viewportMinimum)&&(!n(this.options.viewportMaximum)&&this.options.viewportMinimum>=this.options.viewportMaximum)&&(this.viewportMinimum=this.viewportMaximum=null);
...
this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue||!n(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[b].endValue||!n(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue)){this.scaleBreaks._appliedBreaks.splice(b,1);break}if("axisX"===this.type){if(this.dataSeries&&0<this.dataSeries.length)for(e=0;e<this.dataSeries.length;e++)"dateTime"===this.dataSeries[e].xValueType&&(c=!0);e=null!==this.viewportMinimum?
...
b/250<=a?(this.interval=250,this.intervalType="millisecond"):b/300<=a?(this.interval=300,this.intervalType="millisecond"):b/400<=a?(this.interval=400,this.intervalType="millisecond"):b/500<=a?(this.interval=500,this.intervalType="millisecond"):b/(1*L.secondDuration)<=a?(this.interval=1,this.intervalType="second"):b/(2*L.secondDuration)<=a?(this.interval=2,this.intervalType="second"):b/(5*L.secondDuration)<=a?(this.interval=5,this.intervalType="second"):b/(10*L.secondDuration)<=a?(this.interval=10,
this.intervalType="second"):b/(15*L.secondDuration)<=a?(this.interval=15,this.intervalType="second"):b/(20*L.secondDuration)<=a?(this.interval=20,this.intervalType="second"):b/(30*L.secondDuration)<=a?(this.interval=30,this.intervalType="second"):b/(1*L.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):b/(2*L.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):b/(5*L.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):b/(10*L.minuteDuration)<=a?(this.interval=
10,this.intervalType="minute"):b/(15*L.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):b/(20*L.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):b/(30*L.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):b/(1*L.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):b/(2*L.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):b/(3*L.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):b/(6*L.hourDuration)<=a?(this.interval=6,this.intervalType=
"hour"):b/(1*L.dayDuration)<=a?(this.interval=1,this.intervalType="day"):b/(2*L.dayDuration)<=a?(this.interval=2,this.intervalType="day"):b/(4*L.dayDuration)<=a?(this.interval=4,this.intervalType="day"):b/(1*L.weekDuration)<=a?(this.interval=1,this.intervalType="week"):b/(2*L.weekDuration)<=a?(this.interval=2,this.intervalType="week"):b/(3*L.weekDuration)<=a?(this.interval=3,this.intervalType="week"):b/(1*L.monthDuration)<=a?(this.interval=1,this.intervalType="month"):b/(2*L.monthDuration)<=a?(this.interval=
2,this.intervalType="month"):b/(3*L.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*L.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*L.yearDuration)<=a?1:b/(2*L.yearDuration)<=a?2:b/(4*L.yearDuration)<=a?4:Math.floor(A.getNiceNumber(b/(a-1),!0)/L.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-d/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=
...
isNaN(this.viewportMaximum))this.viewportMaximum=this.maximum;if(this.scaleBreaks)for(d=0;d<this.scaleBreaks._appliedBreaks.length;d++)if((!n(this.sessionVariables.newViewportMinimum)&&this.sessionVariables.newViewportMinimum>=this.scaleBreaks._appliedBreaks[d].startValue||!n(this.options.minimum)&&this.options.minimum>=this.scaleBreaks._appliedBreaks[d].startValue||!n(this.options.viewportMinimum)&&this.viewportMinimum>=this.scaleBreaks._appliedBreaks[d].startValue)&&(!n(this.sessionVariables.newViewportMaximum)&&
...
A.prototype.getLabelStartPoint=function(){var a=L[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
a.setSeconds(0),a.setMilliseconds(0));return a};pa(ea,T);pa(ca,T);ca.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var g=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Da(this.parent[this.optionsName]),g=this.parent.options[this.optionsName].indexOf(this.options));this.options="undefined"===typeof a?{}:a;this.parent.options[this.optionsName][g]=this.options}};ca.prototype.render=function(a){if(0!==
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;X(this.id);var d,q,m,n,k,l;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(G(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,q=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,m=this.chart.plotArea.y2+
p/2+0.5<<0):(e=this.chart.plotArea.y2,m=this.chart.plotArea.y1-p/2+0.5<<0,a*=-1),this.bounds={x1:b-p/2,y1:e,x2:q+p/2,y2:m},this.ctx.moveTo(b,e),"straight"===this.type||"top"===this.scaleBreaks.parent._position&&0>=a||"bottom"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(b,m),this.ctx.lineTo(q,m),this.ctx.lineTo(q,e);else if("wavy"===this.type){n=b;k=e;d=0.5;l=(m-k)/a/3;for(var r=0;r<l;r++)this.ctx.bezierCurveTo(n+d*a,k+a,n+d*a,k+2*a,n,k+3*a),k+=3*a,d*=-1;this.ctx.bezierCurveTo(n+d*a,
k+a,n+d*a,k+2*a,n,k+3*a);n=q;d*=-1;this.ctx.lineTo(n,k);for(r=0;r<l;r++)this.ctx.bezierCurveTo(n+d*a,k-a,n+d*a,k-2*a,n,k-3*a),k-=3*a,d*=-1}else{if("zigzag"===this.type){d=-1;k=e+a;n=b+a;l=(m-k)/a/2;for(r=0;r<l;r++)this.ctx.lineTo(n,k),n+=2*d*a,k+=2*a,d*=-1;this.ctx.lineTo(n,k);n+=q-b;for(r=0;r<l+1;r++)this.ctx.lineTo(n,k),n+=2*d*a,k-=2*a,d*=-1;this.ctx.lineTo(n+d*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<
0,m=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,q=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,q=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:q,y2:m+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(q,e),this.ctx.lineTo(q,m),this.ctx.lineTo(b,m);else if("wavy"===this.type){n=b;k=e;d=0.5;l=
(q-n)/a/3;for(r=0;r<l;r++)this.ctx.bezierCurveTo(n+a,k+d*a,n+2*a,k+d*a,n+3*a,k),n+=3*a,d*=-1;this.ctx.bezierCurveTo(n+a,k+d*a,n+2*a,k+d*a,n+3*a,k);k=m;d*=-1;this.ctx.lineTo(n,k);for(r=0;r<l;r++)this.ctx.bezierCurveTo(n-a,k+d*a,n-2*a,k+d*a,n-3*a,k),n-=3*a,d*=-1}else if("zigzag"===this.type){d=1;k=e-a;n=b+a;l=(q-n)/a/2;for(r=0;r<l;r++)this.ctx.lineTo(n,k),k+=2*d*a,n+=2*a,d*=-1;this.ctx.lineTo(n,k);k+=m-e;for(r=0;r<l+1;r++)this.ctx.lineTo(n,k),k+=2*d*a,n-=2*a,d*=-1;this.ctx.lineTo(n+a,k+d*a)}0<p&&this.ctx.stroke();
this.ctx.closePath();this.ctx.globalAlpha=this.fillOpacity;this.ctx.globalCompositeOperation="destination-over";this.ctx.fill();this.ctx.restore();this.ctx.globalAlpha=c;this.ctx=g}};pa(Q,T);Q.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var g=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Da(this.parent.stripLines),g=this.parent.options.stripLines.indexOf(this.options));this.options="undefined"===
typeof a?{}:a;this.parent.options.stripLines[g]=this.options}};Q.prototype.render=function(){this.ctx.save();var a=this.parent.getPixelCoordinatesOnAxis(this.value),g=Math.abs("pixel"===this._thicknessType?this.thickness:Math.abs(this.parent.convertValueToPixel(this.endValue)-this.parent.convertValueToPixel(this.startValue)));if(0<g){var c=null===this.opacity?1:this.opacity;this.ctx.strokeStyle=this.color;this.ctx.beginPath();var b=this.ctx.globalAlpha;this.ctx.globalAlpha=c;X(this.id);var e,d,n,
m;this.ctx.lineWidth=g;this.ctx.setLineDash&&this.ctx.setLineDash(G(this.lineDashType,g));if("bottom"===this.parent._position||"top"===this.parent._position)e=d=1===this.ctx.lineWidth%2?(a.x<<0)+0.5:a.x<<0,n=this.chart.plotArea.y1,m=this.chart.plotArea.y2,this.bounds={x1:e-g/2,y1:n,x2:d+g/2,y2:m};else if("left"===this.parent._position||"right"===this.parent._position)n=m=1===this.ctx.lineWidth%2?(a.y<<0)+0.5:a.y<<0,e=this.chart.plotArea.x1,d=this.chart.plotArea.x2,this.bounds={x1:e,y1:n-g/2,x2:d,
y2:m+g/2};this.ctx.moveTo(e,n);this.ctx.lineTo(d,m);this.ctx.stroke();this.ctx.globalAlpha=b}this.ctx.restore()};pa(da,T);da.prototype.showAt=function(a){if(!this.enabled)return!1;var g=this.chart,c=!1;g.resetOverlayedCanvas();g.clearedOverlayedCanvas=this.parent.type;this.chart.renderCrosshairs(this.parent);if("xySwapped"===g.plotInfo.axisPlacement)if("bottom"===this.parent._position)for(var b=0;b<g.axisY.length;b++)this.parent===g.axisY[b]&&(g.axisY[b]._crosshairValue=a>=g.axisY[b].viewportMinimum&&
...
(c=!0));this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};da.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};da.prototype.render=function(a,g,c){var b,e,d,q,m=null,t=null,k=null,l="";this.valueFormatString||("dateTime"===this.parent.valueType?this.valueFormatString=this.parent.valueFormatString:(k=0,k="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?
...
this.thickness),f=this.chart.overlaidCanvasCtx,w=f.globalAlpha;f.beginPath();f.strokeStyle=this.color;f.lineWidth=r;f.save();this.labelFontSize=Math.abs(n(this.options.labelFontSize)?this.parent.labelFontSize:this.labelFontSize);this.labelMaxWidth=n(this.options.labelMaxWidth)?0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=n(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:2*this.labelFontSize;0<r&&f.setLineDash&&f.setLineDash(G(this.lineDashType,r));k=new ja(f,{x:0,y:0,
...
r/2,y1:d,x2:e+r/2,y2:q};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/2)+2;k.y+k.height>this.chart.bounds.y2?k.y=this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){d=q=t=1===f.lineWidth%
2?(this.parent.convertValueToPixel(u.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(u.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:d-r/2,x2:e,y2:q+r/2};s=!1;if(this.parent.labels)for(v=Math.ceil(this.parent.interval),l=0;l<this.parent.viewportMaximum;l+=v)if(this.parent.labels[l])s=!0;else{s=!1;break}if(s){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:g}),x=null,s=0;s<this.parent.dataSeries.length;s++)(x=this.parent.dataSeries[s].getDataPointAtX(v,
...
b){return a.distance-b.distance});u=l[0];b=e=m=1===f.lineWidth%2?(this.parent.convertValueToPixel(u.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(u.dataPoint.x)<<0;d=this.chart.plotArea.y1;q=this.chart.plotArea.y2;this.bounds={x1:b-r/2,y1:d,x2:e+r/2,y2:q};s=!1;if(this.parent.labels)for(v=Math.ceil(this.parent.interval),l=0;l<this.parent.viewportMaximum;l+=v)if(this.parent.labels[l])s=!0;else{s=!1;break}if(s){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),x=null,
...
fa(n(c)?u.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=u.dataPoint.y);d=q=t;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:d-r/2,x2:e,y2:q+r/2};k.y=q+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-
...
this.parent.viewportMaximum)&&this.value<=Math.max(this.parent.viewportMinimum,this.parent.viewportMaximum)&&0<r&&(f.moveTo(b,d),f.lineTo(e,q),f.stroke(),this._hidden=!1);if("left"===this.parent._position||"right"===this.parent._position)"left"===this.parent._position&&k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"right"===this.parent._position&&k.x+k.measureText().width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.measureText().width),this.value>=Math.min(this.parent.viewportMinimum,
this.parent.viewportMaximum)&&this.value<=Math.max(this.parent.viewportMinimum,this.parent.viewportMaximum)&&0<r&&(f.moveTo(b,d),f.lineTo(e,q),f.stroke(),this._hidden=!1)}else{if("bottom"===this.parent._position||"top"===this.parent._position)b=e=m=1===f.lineWidth%2?(a<<0)+0.5:a<<0,d=this.chart.plotArea.y1,q=this.chart.plotArea.y2,this.bounds={x1:b-r/2,y1:d,x2:e+r/2,y2:q};else if("left"===this.parent._position||"right"===this.parent._position)d=q=t=1===f.lineWidth%2?(g<<0)+0.5:g<<0,b=this.chart.plotArea.x1,
e=this.chart.plotArea.x2,this.bounds={x1:b,y1:d-r/2,x2:e,y2:q+r/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){s=!1;if(this.parent.labels)for(v=Math.ceil(this.parent.interval),l=0;l<this.parent.viewportMaximum;l+=v)if(this.parent.labels[l])s=!0;else{s=!1;break}if(s){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:g}),x=null,s=0;s<this.parent.dataSeries.length;s++)(x=this.parent.dataSeries[s].getDataPointAtX(v,
...
this.parent._position&&k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2:"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-k.fontSize/2+k.measureText().height>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.height+k.fontSize/2+2);f.globalAlpha=p;0<r&&(f.moveTo(b,d),f.lineTo(e,q),f.stroke(),this._hidden=!1);this.value="bottom"===this.parent._position||"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(g)}if("bottom"===
...
a,this._prevY=g;var b=null,e=null,d=[],q=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){var m=[];if(this.chart.axisX)for(var t=0;t<this.chart.axisX.length;t++){for(var q="xySwapped"===this.chart.plotInfo.axisPlacement?this.chart.axisX[t].convertPixelToValue({y:g}):this.chart.axisX[t].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX[t].dataSeries.length;b++)(k=this.chart.axisX[t].dataSeries[b].getDataPointAtX(q,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[t].dataSeries[b],
null!==k.dataPoint.y&&k.dataSeries.visible&&m.push(k));k=null}if(this.chart.axisX2)for(t=0;t<this.chart.axisX2.length;t++){q="xySwapped"===this.chart.plotInfo.axisPlacement?this.chart.axisX2[t].convertPixelToValue({y:g}):this.chart.axisX2[t].convertPixelToValue({x:a});k=null;for(b=0;b<this.chart.axisX2[t].dataSeries.length;b++)(k=this.chart.axisX2[t].dataSeries[b].getDataPointAtX(q,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[t].dataSeries[b],null!==k.dataPoint.y&&k.dataSeries.visible&&m.push(k));
...
b,k.index=this.currentDataPointIndex,k.distance=Math.abs(b.x-q),"waterfall"===e.type&&(k.cumulativeSumYStartValue=e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue,k.cumulativeSum=e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);else if(this.enabled&&e&&("line"===e.type||"stepLine"===e.type||"spline"===e.type||"area"===e.type||"stepArea"===e.type||"splineArea"===e.type||"stackedArea"===e.type||"stackedArea100"===e.type||"rangeArea"===e.type||"rangeSplineArea"===e.type||
"candlestick"===e.type||"ohlc"===e.type||"boxAndWhisker"===e.type))q=e.axisX.convertPixelToValue({x:a}),k=e.getDataPointAtX(q,c),n(k)||(k.dataSeries=e,this.currentDataPointIndex=k.index,b=k.dataPoint);else{"toolTip"===this.chart.clearedOverlayedCanvas&&(this.chart.resetOverlayedCanvas(),this.chart.clearedOverlayedCanvas=null);return}if(!n(k)&&!n(k.dataPoint)&&!n(k.dataPoint.y))if(k.dataSeries.axisY)if(0<k.dataPoint.y.length){for(b=c=0;b<k.dataPoint.y.length;b++)k.dataPoint.y[b]<k.dataSeries.axisY.viewportMinimum?
...
k.dataSeries.axisY.viewportMaximum)&&d.push(k);else d.push(k)}}if(0<d.length){if(this.highlightObjects(d),this.enabled){c="";c=this.getToolTipInnerHTML({entries:d});if(null!==c){this.contentDiv.innerHTML=c;if(this.isToolTipDefinedInData&&n(this.options.content)&&n(this.options.contentFormatter))for(q=this.contentDiv.getElementsByTagName("span"),b=0;b<q.length;b++)q[b]&&(q[b].style.color=q[b].getAttribute("data-color"));q=!1;"none"===this.container.style.display&&(q=!0,this.container.style.display=
...
"stackedColumn"===c.type||"stackedColumn100"===c.type||"stackedBar"===c.type||"stackedBar100"===c.type||"stackedArea"===c.type||"stackedArea100"===c.type||"waterfall"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(h+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),h+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}",
m=c.axisXIndex):"bubble"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(h+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),h+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}"):"rangeColumn"===c.type||"rangeBar"===c.type||"rangeArea"===c.type||"rangeSplineArea"===c.type||
"error"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(h+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),h+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"):"candlestick"===c.type||"ohlc"===c.type?(this.chart.axisX&&1<this.chart.axisX.length&&(h+=m!=c.axisXIndex?c.axisX.title?
c.axisX.title+"<br/>":"X:{axisXIndex}<br/>":""),h+=b.toolTipContent?b.toolTipContent:c.toolTipContent?c.toolTipContent:this.content&&"function"!==typeof this.content?this.content:"<span data-color='\""+(this.options.fontColor?"":"'{color}'")+"\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}"):"boxAndWhisker"===c.type&&(this.chart.axisX&&1<this.chart.axisX.length&&(h+=m!=c.axisXIndex?c.axisX.title?c.axisX.title+
...
2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();t.version="v3.8.8 GA";window.CanvasJS&&(t&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=t)})();
