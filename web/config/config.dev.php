...
// Loopback parity runtime: old PHPExcel emits PHP-version deprecations before rendering.
...
$config['sess_save_path'] = sys_get_temp_dir() . '/ci3-sessions';
